...
--
/
CREATE OR REPLACE EDITIONABLE TYPE BODY "DL_COMMON"."OT_DB_TAB_COL_TBLSPC" is
  --
  -- *** STATICS ***
  --
  --
  ...
  * Author    Date        Description                                            *
  * --------  ----------  -------------------------------------------------------*
  * WWirns    15.02.2018  DL_COMMON.OT_DB_TAB_COL_TBLSPC:Added
  *******************************************************************************/
  --
  ...
  *******************************************************************************/
  ...
  static function Construct(p_OBJ_TYPE          in varchar2
                           ...
                           ,p_Is_Case_Sensitive in pls_integer default 0
                            --
                            ) return OT_DB_TAB_COL_TBLSPC is
    --
    v_Result OT_DB_TAB_COL_TBLSPC;
    --
  begin
    v_Result := new OT_DB_TAB_COL_TBLSPC(null
                                        ,null
                                        ,null);
  ...
  *******************************************************************************/
  --
  constructor function OT_DB_TAB_COL_TBLSPC(self      in out nocopy OT_DB_TAB_COL_TBLSPC
                                           ,OBJ_TYPE  in varchar2
                                           ,OBJ_OWNER in varchar2
                                           ,OBJ_NAME  in varchar2
                                           ,COL_NAME  in varchar2
  ...
  *******************************************************************************/
  --
  final member procedure Initialize(self                in out nocopy OT_DB_TAB_COL_TBLSPC
                                   ,p_OBJ_TYPE          in varchar2
                                   ,p_OBJ_OWNER         in varchar2
                                   ,p_OBJ_NAME          in varchar2
                                   ,p_COL_NAME          in varchar2
  ...
  begin
    --
    --
    (self as OT_DB_TAB_COL).Initialize(p_OBJ_TYPE
                                      ,p_OBJ_OWNER
                                      ,p_OBJ_NAME
                                      ,p_COL_NAME
                                      ,p_Is_Case_Sensitive);
