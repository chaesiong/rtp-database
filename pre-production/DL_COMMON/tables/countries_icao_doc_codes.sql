CREATE TABLE "DL_COMMON"."COUNTRIES_ICAO_DOC_CODES" 
  ...
  USING INDEX  ENABLE;
  ALTER TABLE "DL_COMMON"."COUNTRIES_ICAO_DOC_CODES" ADD CONSTRAINT "COUNTRIES_ICAO_CODES_UK_ICAO" UNIQUE ("ICAO_CODE")
  USING INDEX  ENABLE;
  ...
  ;
CREATE UNIQUE INDEX "DL_COMMON"."COUNTRIES_ICAO_CODES_UK_ICAO" ON "DL_COMMON"."COUNTRIES_ICAO_DOC_CODES" ("ICAO_CODE") 
  ;
  ...
  GRANT SELECT ON "DL_COMMON"."COUNTRIES_ICAO_DOC_CODES" TO "TESTADM";
