...
CREATE UNIQUE INDEX "DL_COMMON"."FINGER_STATUS$UQ00" ON "DL_COMMON"."FINGER_STATUS" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."FINGER_STATUS" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."FINGER_STATUS$TIUD0" 
  for insert or update or delete on DL_COMMON.FINGER_STATUS
  compound trigger
--
  --
  /*******************************************************************************
