...
CREATE UNIQUE INDEX "DL_COMMON"."ACTION_CODES$UQ00" ON "DL_COMMON"."ACTION_CODES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."ACTION_CODES" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."ACTION_CODES$TIUD0" 
  for insert or update or delete on DL_COMMON.ACTION_CODES
  compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE        in ACTION_CODES.KEY_VALUE%type
                               ,o_OWNER            in ACTION_CODES.OWNER%type
                               ,n_OWNER            in ACTION_CODES.OWNER%type
                               --
                               ) is
    --
