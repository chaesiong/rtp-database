...
CREATE UNIQUE INDEX "DL_COMMON"."FINGER_MISS_REASONS$UQ00" ON "DL_COMMON"."FINGER_MISS_REASONS" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."FINGER_MISS_REASONS" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."FINGER_MISS_REASONS$TIUD0" 
  for insert or update or delete on DL_COMMON.FINGER_MISS_REASONS
  compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  begin
    ...
    then
      --
      insert into FINGER_MISS_REASONS$HIS
	   (KEY_VALUE
        ,LOCALE
        ,DISPLAY_VALUE
        ,DISPLAY_ORDER
