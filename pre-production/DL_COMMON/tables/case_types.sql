...
CREATE UNIQUE INDEX "DL_COMMON"."CASE_TYPES$UQ00" ON "DL_COMMON"."CASE_TYPES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."CASE_TYPES" TO "TESTADM";
  GRANT INSERT ON "DL_COMMON"."CASE_TYPES" TO "TRAINEE";
  GRANT SELECT ON "DL_COMMON"."CASE_TYPES" TO "TRAINEE";
  GRANT UPDATE ON "DL_COMMON"."CASE_TYPES" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."CASE_TYPES$TIUD0" 
  for insert or update or delete on DL_COMMON.CASE_TYPES
  compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE        in CASE_TYPES.KEY_VALUE%type
                               ,o_OWNER            in CASE_TYPES.OWNER%type
                               ,n_OWNER            in CASE_TYPES.OWNER%type
                               --
                               ) is
    --
