...
CREATE UNIQUE INDEX "DL_COMMON"."TRANS_MODES$UQ00" ON "DL_COMMON"."TRANS_MODES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."TRANS_MODES" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."TRANS_MODES$TIUD0" 
  for insert or update or delete on DL_COMMON.TRANS_MODES
  compound trigger
--
  --
  /*******************************************************************************
  ...
  * WWirns    08.11.2017  Added column BORDER_TYPE
  ...
  *******************************************************************************/
  ...
  begin
    ...
    if (:new.KEY_VALUE != :old.KEY_VALUE
       ...
       or :new.NUM_VALUE != :old.NUM_VALUE
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE   in TRANS_MODES.KEY_VALUE%type
                              ,o_BORDER_TYPE in TRANS_MODES.BORDER_TYPE%type
                              ,n_BORDER_TYPE in TRANS_MODES.BORDER_TYPE%type
                               --
                               ) is
    --
    v_c_Tmp char(1);
