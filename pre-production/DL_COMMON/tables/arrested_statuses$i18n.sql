...
CREATE UNIQUE INDEX "DL_COMMON"."ARRESTED_STATUSES$I18N$PK" ON "DL_COMMON"."ARRESTED_STATUSES$I18N" ("KEY_VALUE", "LOCALE") 
  ...
  GRANT SELECT ON "DL_COMMON"."ARRESTED_STATUSES$I18N" TO "TESTADM";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_STATUSES$I18N" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."ARRESTED_STATUSES$I18N$TIUD0" 
  for insert or update or delete on DL_COMMON.ARRESTED_STATUSES$I18N
  compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE        in ARRESTED_STATUSES$I18N.KEY_VALUE%type
                               ,p_LOCALE           in ARRESTED_STATUSES$I18N.LOCALE%type
                               ,o_OWNER            in ARRESTED_STATUSES$I18N.OWNER%type
                               ,n_OWNER            in ARRESTED_STATUSES$I18N.OWNER%type
                               --
                               ) is
    --
  ...
  */
  ...
  begin
    ...
    then
      ...
      --
      insert into ARRESTED_STATUSES$I18N$HIS
      values
        (:old.KEY_VALUE
        ,:old.LOCALE
        ,:old.DISPLAY_VALUE
  ...
  */
  ...
  --
end ARRESTED_STATUSES$I18N$TIUD0;
/
