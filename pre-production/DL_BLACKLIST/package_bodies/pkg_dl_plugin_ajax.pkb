CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_BLACKLIST"."PKG_DL_PLUGIN_AJAX" AS
  ...
  FUNCTION process_ajax_item_request(p_item IN apex_plugin.T_PAGE_ITEM, p_plugin IN apex_plugin.T_PLUGIN)
    ...
    BEGIN
      ...
      --
      -- TEMP MPS
      /*INSERT INTO dl_blacklist.XXTMP_MPS_LOG (TYPE, v_APP_AJAX_X01, v_APP_AJAX_X02, v_APP_AJAX_X03, v_APP_AJAX_X04, v_APP_AJAX_X05, v_APP_AJAX_X10)
      VALUES ('1', v_APP_AJAX_X01, v_APP_AJAX_X02, v_APP_AJAX_X03, v_APP_AJAX_X04, v_APP_AJAX_X05, v_APP_AJAX_X10);
      COMMIT;*/
      --
      /*
  ...
  FUNCTION process_ajax_region_request(p_region IN apex_plugin.T_REGION, p_plugin IN apex_plugin.T_PLUGIN)
    ...
    BEGIN
      ...
      -- TEMP MPS
      /*INSERT INTO dl_blacklist.XXTMP_MPS_LOG (TYPE, v_APP_AJAX_X01, v_APP_AJAX_X02, v_APP_AJAX_X03, v_APP_AJAX_X04, v_APP_AJAX_X05, v_APP_AJAX_X10)
      VALUES ('2', v_APP_AJAX_X01, v_APP_AJAX_X02, v_APP_AJAX_X03, v_APP_AJAX_X04, v_APP_AJAX_X05, v_APP_AJAX_X10);
      COMMIT;*/
      --
      IF NOT APEX_COLLECTION.collection_exists(p_collection_name => v_APP_AJAX_X01)
      THEN
