...
CREATE UNIQUE INDEX "DL_BLACKLIST"."FACES_PK" ON "DL_BLACKLIST"."FACES" ("ID") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."FACES" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."FACES" TO "TRAINEE";
