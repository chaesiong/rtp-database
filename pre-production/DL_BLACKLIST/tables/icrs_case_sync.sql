...
CREATE UNIQUE INDEX "DL_BLACKLIST"."SYS_IL0000312656C00006$$" ON "DL_BLACKLIST"."ICRS_CASE_SYNC" (
  ...
  GRANT SELECT ON "DL_BLACKLIST"."ICRS_CASE_SYNC" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."ICRS_CASE_SYNC" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."ICRS_CASE_SYNC" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."ICRS_CASE_SYNC" TO "TRAINEE";
