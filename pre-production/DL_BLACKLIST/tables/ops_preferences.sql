CREATE TABLE "DL_BLACKLIST"."OPS_PREFERENCES" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."OPS_PREFERENCES" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."OPS_PREFERENCES" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."OPS_PREFERENCES" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."OPS_PREFERENCES" TO "TRAINEE";
