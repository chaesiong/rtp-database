CREATE TABLE "DL_BLACKLIST"."ICRS_CASE_SYNC$HIS" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."ICRS_CASE_SYNC$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."ICRS_CASE_SYNC$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."ICRS_CASE_SYNC$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."ICRS_CASE_SYNC$HIS" TO "TRAINEE";
