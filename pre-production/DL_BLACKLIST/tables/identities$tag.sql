CREATE TABLE "DL_BLACKLIST"."IDENTITIES$TAG" 
  ...
  ALTER TABLE "DL_BLACKLIST"."IDENTITIES$TAG" ADD CONSTRAINT "IDENTITIES$TAG$FK00" FOREIGN KEY ("KEY_VALUE")
	  REFERENCES "DL_BLACKLIST"."IDENTITIES" ("KEY_VALUE") ON DELETE CASCADE ENABLE;
  ...
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "TRAINEE";
