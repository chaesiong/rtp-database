CREATE TABLE "DL_BLACKLIST"."TRAVEL_DOCS$TAG" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."TRAVEL_DOCS$TAG" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."TRAVEL_DOCS$TAG" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."TRAVEL_DOCS$TAG" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."TRAVEL_DOCS$TAG" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_BLACKLIST"."TRAVEL_DOCS$TAG$TIUD0" 
  for insert or update or delete on DL_BLACKLIST.TRAVEL_DOCS$TAG
  compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE in TRAVEL_DOCS$TAG.KEY_VALUE%type
                              ,p_OWNER     in TRAVEL_DOCS$TAG.OWNER%type
                              ,p_TAG       in TRAVEL_DOCS$TAG.TAG%type
                              ,o_OWNER     in TRAVEL_DOCS$TAG.OWNER%type
                              ,n_OWNER     in TRAVEL_DOCS$TAG.OWNER%type
                               --
                               ) is
    --
  ...
  */
  ...
  begin
    ...
    then
      ...
      --
      insert into TRAVEL_DOCS$TAG$HIS
      values
        (:old.KEY_VALUE
        ,:old.OWNER
        ,:old.TAG
  ...
  */
  ...
  --
end TRAVEL_DOCS$TAG$TIUD0;
/
ALTER TRIGGER "DL_BLACKLIST"."TRAVEL_DOCS$TAG$TIUD0" ENABLE;
