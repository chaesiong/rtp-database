...
CREATE UNIQUE INDEX "DL_BLACKLIST"."FINGERPRINTS_PK" ON "DL_BLACKLIST"."FINGERPRINTS" ("ID") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."FINGERPRINTS" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."FINGERPRINTS" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."FINGERPRINTS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."FINGERPRINTS" TO "TRAINEE";
