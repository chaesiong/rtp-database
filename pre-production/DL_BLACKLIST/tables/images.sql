...
CREATE UNIQUE INDEX "DL_BLACKLIST"."SYS_IL0000312625C00005$$" ON "DL_BLACKLIST"."IMAGES" (
  ...
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."IMAGES" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."IMAGES" TO "TRAINEE";
