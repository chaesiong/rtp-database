CREATE TABLE "DL_BLACKLIST"."RELATED_PERSONS" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."RELATED_PERSONS" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."RELATED_PERSONS" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."RELATED_PERSONS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."RELATED_PERSONS" TO "TRAINEE";
