CREATE TABLE "DL_BLACKLIST"."IDENTITIES$TAG$HIS" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."IDENTITIES$TAG$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."IDENTITIES$TAG$HIS" TO "TRAINEE";
