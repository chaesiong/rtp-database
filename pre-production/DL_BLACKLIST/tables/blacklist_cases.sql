CREATE TABLE "DL_BLACKLIST"."BLACKLIST_CASES" 
  ...
  ALTER TABLE "DL_BLACKLIST"."BLACKLIST_CASES" ADD CONSTRAINT "BLACKLIST_CASES_CASE_TYPE" FOREIGN KEY ("CASE_TYPE")
   ...
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ID" IS 'Artificial primary key';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."AUTHORITY" IS 'Name of the filing government agency';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."BEHAVIOR" IS 'Description of the behavior in match case';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CASE_NUMBER" IS 'Case number of the filing government agency';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."SECRET_LEVEL" IS 'FK  DL_COMMON.SECRET_LEVELS';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."REASON" IS 'FK  DL_COMMON.REASON_CODES';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."IS_ACTIVE" IS 'Switch for soft delete';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."INS_BY" IS 'Created by User name';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."INS_AT" IS 'Created at timestamp';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."DML_BY" IS 'Modified by User name';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."DML_AT" IS 'Modified at timestamp';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."DML_TYPE" IS 'What type of DML was the last change of the record';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."URGENT_CONTACT" IS 'Telefon number ';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CONTACT_INFORMATION" IS 'Contact address';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TARGET_CODE" IS 'Target code of the filing government agency';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ACTION_CODE" IS 'FK DL_COMMON.ACTION_CODES';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."NOTICE" IS 'Case notice';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."REFERENCE_DOCUMENT" IS 'Reference document case number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."WARRANT_ARRESTED_TYPE" IS 'FK DL_COMMON.ARRESTED_TYPES';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CRIMINAL_CASE_NUMBER" IS 'Reference criminal case number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_DESCRIPTION" IS 'Arrested description';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_STATUS" IS 'FK DL_COMMON.ARRESTED_STATUSES';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."DECIDED_CASE_NUMBER" IS 'Decided case number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_WARRANT_EXPIRY_DATE" IS 'Date of warrant expiry';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."RELATED_DOCUMENT" IS 'Related document case number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_WARRANT_NUMBER" IS 'Warrant number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_WARRANT_DATE" IS 'Warrant date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT" IS 'Y/N';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT_FROM" IS 'Warrant number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT_TO" IS 'Travel permit from';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT_DATE_INSERT" IS 'Travel permit date inserted';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT_DATE_DELETE" IS 'Travel permit date deleted';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."TRAVEL_PERMIT_NOTE" IS 'Travel permit notice';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OWNER_DATA" IS 'Filing government agency';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OTHER_DESCRIPTION" IS 'Description';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CONTACT_TELEPHONE_NUMBER" IS 'Contact telephone number';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CONTACT_OWNER_DATA" IS 'Filing government agency address';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ASSOCIATED_BEHAVIOR" IS 'Filing government agency behaviour';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OTHER" IS 'Other';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CASE_TYPE" IS 'Case type (Criminal, Overstay, Lost Passport, Prohibit Marking)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_CREATION_DATE" IS 'Overstay Created Date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_SELF_INDICTMENT" IS 'Overstay self-indictment / caught';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_STATUS" IS 'Overstay Status - to be clarified';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_NO_DAYS" IS 'Overstay (Number) Days';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_ARRIVAL_DATE" IS 'Overstay Arrival date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_DEPARTURE_DATE" IS 'Overstay Departure date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_TM6" IS 'Overstay T.M 6.';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_BLOCK_PERIOD" IS 'Overstay Blocking period';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."OSTAY_NOTICE" IS 'Overstay Remark';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_LOST_DATE" IS 'Lost Passport lost date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_LAST_PLACE" IS 'Lost Passport Last place';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NOTIFY_DATE" IS 'Lost Passport Notify lost date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NOTIFY_PLACE" IS 'Lost Passport Notify place (Issuing Place)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_VISA_ON_ARRIV" IS 'Lost Passport Visa on Arrival';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_VISA_EXP_DATE" IS 'Lost Passport Visa expire date';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NOTICE" IS 'Lost Passport Remark';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NEW_PP_TYPE" IS 'Lost Passport Data: New Passport Type (THA20675-692)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NEW_PP_NUMBER" IS 'Lost Passport Data: New Passport number (THA20675-692)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NEW_PP_ISSUE_DATE" IS 'Lost Passport Data: New Issue Date (THA20675-692)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NEW_PP_PLACE_OF_ISSUE" IS 'Lost Passport Data: New Place of issue (THA20675-692)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."LOST_PP_NEW_PP_EXPIRE_DATE" IS 'Lost Passport Data: New Passport expire date (THA20675-692)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."ARRESTED_WARRANT_YEAR" IS 'Year of warrant (THA20675-1333)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."UNDECIDED_CASE_NUMBER" IS 'Number of undecided case (THA20675-1333)';
   COMMENT ON COLUMN "DL_BLACKLIST"."BLACKLIST_CASES"."CLOSING_REASON" IS 'Reason for closing a case';
   COMMENT ON TABLE "DL_BLACKLIST"."BLACKLIST_CASES"  IS 'Case Data';
...
CREATE UNIQUE INDEX "DL_BLACKLIST"."BLACKLIST_CASE_UK_AUTHORITY_CASE_NUMBER" ON "DL_BLACKLIST"."BLACKLIST_CASES" ("AUTHORITY", "CASE_NUMBER", "CASE_TYPE") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."BLACKLIST_CASES" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."BLACKLIST_CASES" TO "TRAINEE";
