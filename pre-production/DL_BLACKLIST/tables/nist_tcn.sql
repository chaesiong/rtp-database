...
CREATE UNIQUE INDEX "DL_BLACKLIST"."NIST_TCN$UQ00" ON "DL_BLACKLIST"."NIST_TCN" ("NIST_TCN_NO") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."NIST_TCN" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."NIST_TCN" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."NIST_TCN" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."NIST_TCN" TO "TRAINEE";
