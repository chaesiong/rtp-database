CREATE TABLE "DL_BLACKLIST"."RELATED_PERSONS$HIS" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."RELATED_PERSONS$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BLACKLIST"."RELATED_PERSONS$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BLACKLIST"."RELATED_PERSONS$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BLACKLIST"."RELATED_PERSONS$HIS" TO "TRAINEE";
