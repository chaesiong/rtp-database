...
WHERE rn = 1;
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "TESTADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "TRAINEE";
