CREATE OR REPLACE EDITIONABLE PACKAGE "DL_STAGING4PIBICS_INTF"."PKG_ST_LOSTPASSPORT" AUTHID DEFINER AS
    ...
    /*  processes for data transport between DL_STAGING4PIBICS.LOSTPASSPORT  and
                      DL_BORDERCONTROL.SYNC_X_VOID_PASSPORTS
    */

    gc_process_name CONSTANT pkg_utils.table_name := 'LOSTPASSPORT';
