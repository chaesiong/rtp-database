CREATE OR REPLACE EDITIONABLE PACKAGE "DL_STAGING4PIBICS_INTF"."PKG_ST_TMINOUT" AUTHID DEFINER AS
    ...
    /*  processes for data transport between DL_STAGING4PIBICS.TMINOUT  and
                      DL_BORDERCONTROL.SYNC_MOVEMENTS
    */
    gc_process_name CONSTANT pkg_utils.table_name := 'TMINOUT';
