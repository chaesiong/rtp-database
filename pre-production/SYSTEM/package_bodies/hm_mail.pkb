CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."HM_MAIL" is
  ...
  BEGIN
    ...
    LOOP
      ...
      v_clob       := v_clob || to_clob(utl_raw.cast_to_varchar2(v_buffer_raw) || chr(13) ||
                                        chr(10));
 ...
 procedure send_encode_base64(p_conn    in out utl_smtp.connection,
  ...
  begin
    ...
    v_mail_conn := utl_smtp.open_connection('127.0.0.1', 25);
