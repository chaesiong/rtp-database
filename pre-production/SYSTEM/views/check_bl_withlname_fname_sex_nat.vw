CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."CHECK_BL_WITHLNAME_FNAME_SEX_NAT" ("MVMNTID", "DATE_OF_ENTRY", "DOCNO", "GIVENNAME", "SURNAME", "BSEX", "NAT", "BCALC_DOB", "EXPIRYDATE", "FORM_NO", "FIRSTNM", "LASTNM", "SEX", "ABBCOUNT", "BIRTHDTE", "CALC_DOB", "WLCD", "REMARK", "REASONCD", "REASONENM", "REASONTNM") AS 
  select m.mvmntid
, m.DATE_OF_ENTRY
, d.DOCNO
, d.givenname
...
d.GIVENNAME = pibics.LASTNM and
d.surname = pibics.FIRSTNM and
...
--and trunc(m.DATE_OF_ENTRY) = TO_DATE('13-jan-2019','dd-mon-yyyy')
