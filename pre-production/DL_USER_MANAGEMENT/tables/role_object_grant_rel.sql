...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL$PK" ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" ("ID") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" TO "TESTADM";
  GRANT DELETE ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" TO "TRAINEE";
  GRANT INSERT ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" TO "TRAINEE";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" TO "TRAINEE";
  GRANT UPDATE ON "DL_USER_MANAGEMENT"."ROLE_OBJECT_GRANT_REL" TO "TRAINEE";
