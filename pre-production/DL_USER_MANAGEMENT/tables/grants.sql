...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."GRANTS$UQ00" ON "DL_USER_MANAGEMENT"."GRANTS" ("NAME") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "TESTADM";
  GRANT INSERT ON "DL_USER_MANAGEMENT"."GRANTS" TO "TRAINEE";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "TRAINEE";
  GRANT UPDATE ON "DL_USER_MANAGEMENT"."GRANTS" TO "TRAINEE";
