...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."USER_ROLE_REL$PK" ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" ("ID") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" TO "TESTADM";
  GRANT DELETE ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" TO "TRAINEE";
  GRANT INSERT ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" TO "TRAINEE";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" TO "TRAINEE";
  GRANT UPDATE ON "DL_USER_MANAGEMENT"."USER_ROLE_REL" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_USER_MANAGEMENT"."USER_ROLE_REL$TIUD0" 
  for insert or update or delete on DL_USER_MANAGEMENT.USER_ROLE_REL
  compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  --
  procedure L_Check_FK_Content(p_ID in USER_ROLE_REL.ID%type
                               --,o_"[columnname-n]" in USER_ROLE_REL."[columnname-n]"%type
                               --,n_"[columnname-n]" in USER_ROLE_REL."[columnname-n]"%type
                               --
                               ) is
    --
