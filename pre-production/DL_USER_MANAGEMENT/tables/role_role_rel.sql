...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."ROLE_ROLE_REL$UQ01" ON "DL_USER_MANAGEMENT"."ROLE_ROLE_REL" ("ROLE_DN", "MEMBER_ROLE_DN") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."ROLE_ROLE_REL" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_USER_MANAGEMENT"."ROLE_ROLE_REL$TIUD0" 
  for insert or update or delete on DL_USER_MANAGEMENT.ROLE_ROLE_REL
  compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  --
  procedure L_Check_FK_Content(p_ID in ROLE_ROLE_REL.ID%type
                               --,o_"[columnname-n]" in ROLE_ROLE_REL."[columnname-n]"%type
                               --,n_"[columnname-n]" in ROLE_ROLE_REL."[columnname-n]"%type
                               --
                               ) is
    --
  ...
  --
end ROLE_ROLE_REL$TIUD0;
/
ALTER TRIGGER "DL_USER_MANAGEMENT"."ROLE_ROLE_REL$TIUD0" ENABLE;
