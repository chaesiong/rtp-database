...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."OBJECTS$I18N$PK" ON "DL_USER_MANAGEMENT"."OBJECTS$I18N" ("ID", "LOCALE") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."OBJECTS$I18N" TO "TESTADM";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_USER_MANAGEMENT"."OBJECTS$I18N$TIUD0" 
  for insert or update or delete on DL_USER_MANAGEMENT.OBJECTS$I18N
  compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  --
end OBJECTS$I18N$TIUD0;
/
ALTER TRIGGER "DL_USER_MANAGEMENT"."OBJECTS$I18N$TIUD0" ENABLE;
