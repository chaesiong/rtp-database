...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000311906C00009$$" ON "DL_BORDERCONTROL"."ENTRY_FORMS" (
 ...
 (PARTITION "SYS_IL_P7255" ) ;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ENTRY_FORMS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."ENTRY_FORMS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."ENTRY_FORMS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."ENTRY_FORMS" TO "TRAINEE";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."ENTRY_FORMS" TO "DL_BLACKLIST";
