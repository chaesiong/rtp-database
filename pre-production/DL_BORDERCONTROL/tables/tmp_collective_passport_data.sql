...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DA_PK" ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" ("KEY_VALUE", "APP_SESSION") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "TRAINEE";
