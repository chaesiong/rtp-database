...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."TERMINALS_UK1" ON "DL_BORDERCONTROL"."TERMINALS" ("IPADDRESS") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."TERMINALS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."TERMINALS" TO "TRAINEE";
