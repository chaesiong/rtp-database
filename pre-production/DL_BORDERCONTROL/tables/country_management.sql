...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT$PK" ON "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT" ("ID") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."COUNTRY_MANAGEMENT" TO "TRAINEE";
