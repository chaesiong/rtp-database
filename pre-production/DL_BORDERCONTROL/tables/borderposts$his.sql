CREATE TABLE "DL_BORDERCONTROL"."BORDERPOSTS$HIS" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERPOSTS$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."BORDERPOSTS$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERPOSTS$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."BORDERPOSTS$HIS" TO "TRAINEE";
