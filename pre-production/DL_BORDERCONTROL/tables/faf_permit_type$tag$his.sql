CREATE TABLE "DL_BORDERCONTROL"."FAF_PERMIT_TYPE$TAG$HIS" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_PERMIT_TYPE$TAG$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."FAF_PERMIT_TYPE$TAG$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_PERMIT_TYPE$TAG$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."FAF_PERMIT_TYPE$TAG$HIS" TO "TRAINEE";
