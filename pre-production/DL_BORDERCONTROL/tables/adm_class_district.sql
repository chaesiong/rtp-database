...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$UQ01" ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT" ("DISPLAY_CODE", "ADM_CLASS_PROVINCE") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT" TO "TRAINEE";
