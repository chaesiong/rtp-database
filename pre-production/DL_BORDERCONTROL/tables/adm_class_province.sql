...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$UQ01" ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE" ("DISPLAY_CODE", "ADM_CLASS_REGION") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE" TO "TRAINEE";
