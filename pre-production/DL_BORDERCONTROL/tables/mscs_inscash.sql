CREATE TABLE "DL_BORDERCONTROL"."MSCS_INSCASH" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSCASH" TO "TESTADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSCASH" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_BORDERCONTROL"."MSCS_INSCASH$TIUD0" 
  for insert or update or delete on DL_BORDERCONTROL.MSCS_INSCASH
compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE      in MSCS_INSCASH.INSCASH_SEQNO%type
                              ,o_INS_TERMINAL   in MSCS_INSCASH.INS_TERMINAL%type
                              ,n_INS_TERMINAL   in MSCS_INSCASH.INS_TERMINAL%type
                              ,o_INS_BORDERPOST in MSCS_INSCASH.INS_BORDERPOST%type
                              ,n_INS_BORDERPOST in MSCS_INSCASH.INS_BORDERPOST%type
                               --
                               ) is
    --
  ...
  begin
    ...
    then
      ...
      --
      :new.INSCASH_SEQNO := DL_BORDERCONTROL.MSCS_INSCASH$SEQ01.NEXTVAL;
      :new.INS_AT   := sysdate;
  ...
  begin
    ...
    then
      --
      L_Check_FK_Content(:new.INSCASH_SEQNO
                        ,null
                        ,:new.INS_TERMINAL
                        ,null
                        ,:new.INS_BORDERPOST
  ...
  --
end MSCS_INSCASH$TIUD0;
/
ALTER TRIGGER "DL_BORDERCONTROL"."MSCS_INSCASH$TIUD0" ENABLE;
