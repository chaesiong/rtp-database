CREATE TABLE "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$HIS" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."ADM_CLASS_PROVINCE$HIS" TO "TRAINEE";
