...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000312103C00015$$" ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" (
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "TRAINEE";
