...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."PARAMETERS_UK1" ON "DL_BORDERCONTROL"."PARAMETERS" ("NAME") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."PARAMETERS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."PARAMETERS" TO "TRAINEE";
