CREATE TABLE "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$HIS" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$HIS" TO "TRAINEE";
