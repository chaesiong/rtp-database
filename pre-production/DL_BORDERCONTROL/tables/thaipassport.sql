...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."THAIPASSPORT$UQ00" ON "DL_BORDERCONTROL"."THAIPASSPORT" ("CITIZENID", "PASSPORTNO") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "TRAINEE";
