...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH_PK" ON "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."TMP_BLACKLIST_SEARCH" TO "TRAINEE";
