...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000312177C00019$$" ON "DL_BORDERCONTROL"."BIO_IDENTITIES" (
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "TRAINEE";
