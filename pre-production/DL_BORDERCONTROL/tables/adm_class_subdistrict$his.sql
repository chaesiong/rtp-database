CREATE TABLE "DL_BORDERCONTROL"."ADM_CLASS_SUBDISTRICT$HIS" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_SUBDISTRICT$HIS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."ADM_CLASS_SUBDISTRICT$HIS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_SUBDISTRICT$HIS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."ADM_CLASS_SUBDISTRICT$HIS" TO "TRAINEE";
