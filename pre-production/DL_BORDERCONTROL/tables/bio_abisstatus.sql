...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."BIO_ABISSTATUS$PK" ON "DL_BORDERCONTROL"."BIO_ABISSTATUS" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_ABISSTATUS" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."BIO_ABISSTATUS" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_ABISSTATUS" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."BIO_ABISSTATUS" TO "TRAINEE";
