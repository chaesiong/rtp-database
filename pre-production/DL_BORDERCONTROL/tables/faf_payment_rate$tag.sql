CREATE TABLE "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$TAG" 
  ...
  GRANT INSERT ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$TAG" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$TAG" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$TAG" TO "TRAINEE";
  CREATE OR REPLACE EDITIONABLE TRIGGER "DL_BORDERCONTROL"."FAF_PAYMENT_RATE$TAG$TIUD0" 
  for insert or update or delete on DL_BORDERCONTROL.FAF_PAYMENT_RATE$TAG
  compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  /*procedure L_Check_FK_Content(p_KEY_VALUE        in FAF_PAYMENT_RATE.KEY_VALUE%type
                               ,o_"[columnname-n]" in FAF_PAYMENT_RATE."[columnname-n]"%type
                               ,n_"[columnname-n]" in FAF_PAYMENT_RATE."[columnname-n]"%type
                               --
                               ) is
    --
  ...
  */
  ...
  begin
    ...
    then
      --
      --
      insert into FAF_PAYMENT_RATE$TAG$HIS
      values
        (:old.KEY_VALUE
        ,:old.OWNER
        ,:old.TAG
  ...
  */
  ...
  --
end FAF_PAYMENT_RATE$TAG$TIUD0;
/
