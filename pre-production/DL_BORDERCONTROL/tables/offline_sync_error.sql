CREATE TABLE "DL_BORDERCONTROL"."OFFLINE_SYNC_ERROR" 
  ...
  ;
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000489709C00002$$" ON "DL_BORDERCONTROL"."OFFLINE_SYNC_ERROR" (
  ;
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000489709C00003$$" ON "DL_BORDERCONTROL"."OFFLINE_SYNC_ERROR" (
  ;
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_SYNC_ERROR" TO "TESTADM";
