...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000311917C00004$$" ON "DL_BORDERCONTROL"."MOVEMENT_ATTR" (
 ...
 (PARTITION "SYS_IL_P7257" ) ;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."MOVEMENT_ATTR" TO "TESTADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."MOVEMENT_ATTR" TO "TRAINEE";
  GRANT SELECT ON "DL_BORDERCONTROL"."MOVEMENT_ATTR" TO "TRAINEE";
  GRANT UPDATE ON "DL_BORDERCONTROL"."MOVEMENT_ATTR" TO "TRAINEE";
