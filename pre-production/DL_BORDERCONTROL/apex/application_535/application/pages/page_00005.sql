...
,p_name=>'LiveCaptureFace'
,p_page_mode=>'MODAL'
,p_step_title=>'LiveCaptureFace'
,p_step_sub_title=>'LiveCaptureFace'
...
,p_last_upd_yyyymmddhh24miss=>'20190716142502'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55606587560096672)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(93475365249276592)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55606587560096672)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(89402439797832231)
,p_branch_name=>'goto 30'
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:RP:P30_CASE_ID,P30_GOTO_TAB:&P5_CASE_ID.,BiometricImages&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(93475365249276592)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(89399725677832204)
,p_name=>'P5_CASE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(55606587560096672)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(89401829069832225)
,p_name=>'P5_IMAGE_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55606587560096672)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(21606526487345548)
,p_name=>'FaceAccepted'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(55606587560096672)
,p_bind_type=>'bind'
,p_bind_event_type=>'PLUGIN_COM.DERMALOG.FACECAPTURE|REGION TYPE|facecapturestepaccepted'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(21606641787345549)
,p_event_id=>wwv_flow_api.id(21606526487345548)
,p_event_result=>'TRUE'
...
'if ($v("P5_CASE_ID")!="" ) {',
'  $s("P5_IMAGE_URL", this.data.getImageURL(), "", false);',
'  $(''.FaceCaptureContainer'').each(function () {',
'    $(this).FaceCapture(''releaseDevice'');',
'  });',
'    apex.page.submit( ''CANCEL'' );',
'} else {',
'  top.$(''.upload-photo .FaceItem'').FaceItem(''urlToModel'', this.data.getImageURL());',
'  $(''.FaceCaptureContainer'').each(function () {',
'    $(this).FaceCapture(''releaseDevice'');',
'  });',
'setTimeout(function(){apex.navigation.dialog.close(true,["5"])},700);',
'}',
'',
''))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32894656464920142)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(89402595431832232)
,p_process_sequence=>20
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'InitItems'
,p_process_sql_clob=>':P5_IMAGE_URL := NULL;'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32894921619920147)
,p_process_sequence=>10
