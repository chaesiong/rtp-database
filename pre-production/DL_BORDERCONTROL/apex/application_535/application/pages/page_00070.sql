...
,p_last_upd_yyyymmddhh24miss=>'20190718145213'
);
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50305631456241127)
,p_name=>'P70_TRAVELDOC_IMAGE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(99026548928320745)
,p_use_cache_before_default=>'NO'
,p_source=>'P70_TRAVELDOC_IMAGE_ID'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50305780843241128)
,p_name=>'P70_TRAVELDOC_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(99026548928320745)
,p_use_cache_before_default=>'NO'
,p_source=>'P70_TRAVELDOC_ID'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
...
'    ',
'    IF :P70_TRAVELDOC_ID IS NOT NULL AND :P70_TRAVELDOC_IMAGE_ID IS NOT NULL THEN',
'        ',
'        select id into l_face_id from dl_blacklist.faces where image_id = :P70_TRAVELDOC_IMAGE_ID;',
'        IF l_face_id IS NOT NULL THEN',
'            UPDATE DL_BLACKLIST.TRAVEL_DOCS SET face_id = l_face_id where key_value = :P70_TRAVELDOC_ID;',
'        END IF;',
'    END IF;',
'    ',
'EXCEPTION',
