...
'        if(overstayDays<90){',
'            blockingSelectField.setValue(0);',
'        }',
...
'    }',
'    else{',
'        if(overstayDays>0 && overstayDays<365){',
'            blockingSelectField.setValue(5);',
'        }',
'        if(overstayDays>365){',
'            blockingSelectField.setValue(10);',
...
,p_last_upd_yyyymmddhh24miss=>'20190802181522'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50305876889241129)
,p_plug_name=>'Overstay'
,p_region_name=>'Overstayform'
,p_parent_plug_id=>wwv_flow_api.id(51375102299666648)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(15253766136705247)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50305904250241130)
,p_plug_name=>'Get Overstay by Passport Data'
,p_region_name=>'OverstayBMBS'
,p_parent_plug_id=>wwv_flow_api.id(51375102299666648)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15253206288705246)
,p_plug_display_sequence=>20
...
'    , mmo.EXTOVS_DATE',
'    , mmo.FLAGOVERSTAY',
'    , mmo.FINDOVERSTAYDAYS',
'    , mmo.FINDOVERSTAYAMOUNT',
'    , mmo.INS_AT',
'    , mmo.INS_BY',
'    , mmo.DML_AT',
'    , mmo.DML_BY',
...
'join dl_bordercontrol.movements mm on mm.BRDDOCID = bd.BRDDOCID',
'join dl_bordercontrol.mscs_movements_overstay mmo on mmo.MVMNTID = mm.MVMNTID',
'',
'where bd.docno = :P30_OVERSTAY_PASSPORT'))
,p_plug_source_type=>'NATIVE_IG'
,p_ajax_items_to_submit=>'P30_OVERSTAY_PASSPORT'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154337391566616)
,p_name=>'DOCNO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154497819566617)
,p_name=>'ISSUECTRY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154553816566618)
,p_name=>'KEY_VALUE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'KEY_VALUE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154602354566619)
,p_name=>'MVMNTID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154705149566620)
,p_name=>'EXTOVS_DATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'EXTOVS_DATE'
,p_data_type=>'DATE'
,p_is_query_only=>false
,p_item_type=>'NATIVE_DATE_PICKER'
,p_heading=>'Extovs date'
,p_heading_alignment=>'CENTER'
,p_display_sequence=>50
,p_value_alignment=>'CENTER'
,p_attribute_04=>'button'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154812245566621)
,p_name=>'FLAGOVERSTAY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'FLAGOVERSTAY'
,p_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_TEXT_FIELD'
,p_heading=>'Flagoverstay'
,p_heading_alignment=>'LEFT'
,p_display_sequence=>60
,p_value_alignment=>'LEFT'
,p_attribute_05=>'BOTH'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54154947381566622)
,p_name=>'FINDOVERSTAYDAYS'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'FINDOVERSTAYDAYS'
,p_data_type=>'NUMBER'
,p_is_query_only=>false
,p_item_type=>'NATIVE_NUMBER_FIELD'
,p_heading=>'Findoverstaydays'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155070103566623)
,p_name=>'FINDOVERSTAYAMOUNT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'FINDOVERSTAYAMOUNT'
,p_data_type=>'NUMBER'
,p_is_query_only=>false
,p_item_type=>'NATIVE_NUMBER_FIELD'
,p_heading=>'Findoverstayamount'
,p_heading_alignment=>'RIGHT'
,p_display_sequence=>80
,p_value_alignment=>'RIGHT'
,p_attribute_03=>'right'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155145431566624)
,p_name=>'INS_AT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'INS_AT'
,p_data_type=>'DATE'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155222175566625)
,p_name=>'INS_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'INS_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155324727566626)
,p_name=>'DML_AT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155462371566627)
,p_name=>'DML_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155501136566628)
,p_name=>'DML_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155614741566629)
,p_name=>'INS_TERMINAL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(54155792879566630)
...
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(54154212213566615)
,p_internal_uid=>54154212213566615
,p_is_editable=>false
,p_lazy_loading=>false
,p_requires_filter=>false
,p_max_row_count=>100000
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(54173327718571926)
,p_interactive_grid_id=>wwv_flow_api.id(54154212213566615)
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(54173464146571934)
,p_report_id=>wwv_flow_api.id(54173327718571926)
,p_view_type=>'GRID'
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
,p_edit_mode=>false
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54173854549571946)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>1
,p_column_id=>wwv_flow_api.id(54154337391566616)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54174308373571969)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>2
,p_column_id=>wwv_flow_api.id(54154497819566617)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54174877179571972)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>3
,p_column_id=>wwv_flow_api.id(54154553816566618)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54175361575571974)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>4
,p_column_id=>wwv_flow_api.id(54154602354566619)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54175889341571976)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>5
,p_column_id=>wwv_flow_api.id(54154705149566620)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54176375206571978)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>6
,p_column_id=>wwv_flow_api.id(54154812245566621)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54176828288571980)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>7
,p_column_id=>wwv_flow_api.id(54154947381566622)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54177391768571982)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>8
,p_column_id=>wwv_flow_api.id(54155070103566623)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54177834572571985)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>9
,p_column_id=>wwv_flow_api.id(54155145431566624)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54178369778571987)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>10
,p_column_id=>wwv_flow_api.id(54155222175566625)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54178808113571989)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>11
,p_column_id=>wwv_flow_api.id(54155324727566626)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54179360901571991)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>12
,p_column_id=>wwv_flow_api.id(54155462371566627)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54179878677571993)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>13
,p_column_id=>wwv_flow_api.id(54155501136566628)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54180336920571995)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>14
,p_column_id=>wwv_flow_api.id(54155614741566629)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(54180871185571997)
,p_view_id=>wwv_flow_api.id(54173464146571934)
,p_display_seq=>15
,p_column_id=>wwv_flow_api.id(54155792879566630)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_page_plug(
...
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(50305876889241129)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42847660325172143)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42848360750172150)
,p_name=>'P30_DOC_NUMBER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(3134455690378731)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Passport/ Document Number'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_grid_label_column_span=>3
,p_field_template=>wwv_flow_api.id(15276053237705291)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50303018121241101)
,p_name=>'P30_DESTINATION_AGENCY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(3134455690378731)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Destination Agency'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_grid_label_column_span=>3
,p_field_template=>wwv_flow_api.id(15276053237705291)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54155827985566631)
,p_name=>'P30_OVERSTAY_PASSPORT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(50305904250241130)
,p_prompt=>'Passport Number'
,p_source=>'select doc_number from travel_docs where identity = :P30_SELECTED_IDENTITY_ID and rownum = 1;'
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_grid_label_column_span=>3
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54156799322566640)
,p_name=>'P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(50305904250241130)
,p_prompt=>'Iss.Country'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'LOV_ICAO_COUNTRIES'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT',
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(50307812801241149)
,p_event_id=>wwv_flow_api.id(48928690427296301)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_affected_region_id=>wwv_flow_api.id(50305904250241130)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
...
'    ,coalesce(substr(i_sex,1,1),td_sex)',
'    ,place_of_birth',
'    ,coalesce(date_of_birth_i,date_of_birth_td) AS date_of_birth',
'    ,coalesce(nationality_i, nationality_td) as nationality',
'    ,doc_number',
'INTO ',
'    :P30_NOTICE',
'    ,:P30_PROFESSION',
...
'            i.sex as i_sex,',
'            td.sex as td_sex,',
'            i.date_of_birth_partial.getFormatData(''DD/MM/YYYY'') AS date_of_birth_i,',
'            td.date_of_birth_partial.getFormatData(''DD/MM/YYYY'') AS date_of_birth_td,',
'            i.nationality as nationality_i,',
'            td.nationality as nationality_td,',
...
'                                                     AND td.date_of_birth_partial.getFormatData(''DD/MM/YYYY'') IS NOT NULL',
...
||'RACTERISTIC,P30_SURNAME_THAI,P30_MIDDLE_NAME_THAI,P30_GIVEN_NAME_THAI,P30_NIST_LASTNAME,P30_NIST_MIDDLE_NAME,P30_NIST_FIRSTNAME,P30_DATE_OF_BIRTH,P30_SEX,P30_GIVEN_NAME,P30_SURNAME,P30_MIDDLE_NAME,P30_PLACE_OF_BIRTH,P30_DATE_OF_BIRTH_DISPLAY,P30_NATI'
||'ONALITY,P30_DOC_NUMBER'
,p_attribute_04=>'N'
...
'    var nationality = apex.item(''P30_NATIONALITY'').getValue().substr(0,2);',
'    if(nationality == ''D'') nationality = ''DE'';',
'    var nistConfig = {',
...
'        Destinationagencyidentifier: apex.item(''P30_DESTINATION_AGENCY'').getValue(),',
'        transactionControlNumber: data.tcnNo,',
'    }',
'    demographicJSON.PassportNumber = apex.item(''P30_DOC_NUMBER'').getValue();',
'    demographicJSON.NationalityId = nationality+''/''+apex.item(''P30_NATIONALITY'').displayValueFor(apex.item(''P30_NATIONALITY'').getValue());',
'    if(demographicJSON.dateOfBirth && demographicJSON.dateOfBirth != ''''){',
'        demographicJSON.dateOfBirth = demographicJSON.dateOfBirth.replace(/-/g,'''').substr(0,8);',
'    }',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(42848144874172148)
,p_name=>'SearchISO_3166_A2'
,p_event_sequence=>450
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P30_NATIONALITY_LOOKUP'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(42848254151172149)
,p_event_id=>wwv_flow_api.id(42848144874172148)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
' select icao, country from dl_common.icao_doc_codes$lc where icao != country;',
'end;'))
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(54156167212566634)
,p_name=>'SelectOverstayPassport'
,p_event_sequence=>460
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P30_SELECTED_IDENTITY_ID'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(54156226006566635)
,p_event_id=>wwv_flow_api.id(54156167212566634)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
'begin',
'if :P30_SELECTED_IDENTITY_ID is not null then',
'select doc_number, issuing_country INTO :P30_OVERSTAY_PASSPORT, :P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY from travel_docs where identity = :P30_SELECTED_IDENTITY_ID and rownum = 1;',
'',
'end if;',
'',
'end;'))
,p_attribute_02=>'P30_SELECTED_IDENTITY_ID'
,p_attribute_03=>'P30_OVERSTAY_PASSPORT,P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(54156322384566636)
,p_name=>'RefreshOverstayReport'
,p_event_sequence=>470
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P30_OVERSTAY_PASSPORT'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(54156667277566639)
,p_event_id=>wwv_flow_api.id(54156322384566636)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'apex.item(''P30_OSTAY_SELF_INDICTMENT'').setValue(''N'');',
'apex.item(''P30_OSTAY_BLOCK_PERIOD'').setValue(''0'');',
'apex.item(''P30_OSTAY_NO_DAYS'').setValue('''');',
'apex.item(''P30_OSTAY_ARRIVAL_DATE'').setValue('''');',
'apex.item(''P30_OSTAY_DEPARTURE_DATE'').setValue('''');',
'apex.item(''P30_OSTAY_TM6'').setValue('''');'))
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(54156575420566638)
,p_event_id=>wwv_flow_api.id(54156322384566636)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
':P30_OVERSTAY_CREATED_DATE := null;',
':P30_OSTAY_SELF_INDICTMENT := null;',
':P30_OSTAY_NO_DAYS := null;',
':P30_OSTAY_TM6  := null;',
':P30_OSTAY_DEPARTURE_DATE  := null;',
':P30_OSTAY_ARRIVAL_DATE   := null;',
'',
'select ',
'         mmo.EXTOVS_DATE',
'        , mmo.FLAGOVERSTAY',
'        , mmo.FINDOVERSTAYDAYS',
'        , (select FORM_NO FROM dl_bordercontrol.ENTRY_FORMS where key_value = mm.entry_form)',
'        , mm.MOVEMENT_DT',
'        , (select MOVEMENT_DT from dl_bordercontrol.movements where BRDDOCID = bd.BRDDOCID and EXITFLG = 0 order by MOVEMENT_DT desc fetch first 1 row only )',
'    into',
'        :P30_OVERSTAY_CREATED_DATE    ',
'        ,:P30_OSTAY_SELF_INDICTMENT',
'        ,:P30_OSTAY_NO_DAYS',
'        ,:P30_OSTAY_TM6',
'        ,:P30_OSTAY_DEPARTURE_DATE',
'        ,:P30_OSTAY_ARRIVAL_DATE',
'    from ',
'       dl_bordercontrol.borderdocuments bd',
'    join dl_bordercontrol.movements mm on mm.BRDDOCID = bd.BRDDOCID',
'    join dl_bordercontrol.mscs_movements_overstay mmo on mmo.MVMNTID = mm.MVMNTID',
'',
'where bd.docno = :P30_OVERSTAY_PASSPORT and mm.BRDDOCID = bd.BRDDOCID and (:P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY is null or bd.ISSUECTRY = :P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY);',
'    ',
'EXCEPTION ',
'',
...
'',
'end;'))
,p_attribute_02=>'P30_OVERSTAY_PASSPORT, P30_OVERSTAY_PASSPORT_ISSUING_COUNTRY'
,p_attribute_03=>'P30_OSTAY_NO_DAYS,P30_OVERSTAY_CREATED_DATE,P30_OSTAY_SELF_INDICTMENT, P30_OSTAY_TM6, P30_OSTAY_DEPARTURE_DATE,P30_OSTAY_ARRIVAL_DATE'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(54156403570566637)
,p_event_id=>wwv_flow_api.id(54156322384566636)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
