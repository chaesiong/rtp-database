...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9367970674456132103)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(9367970811652132104)
...
,p_owner=>'E1MSTAHL'
,p_internal_uid=>9367970811652132104
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682073116440666021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682073551259666021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682072314010666020)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682072770529666021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682068408066666013)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682070842135666018)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682069671846666016)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682070010993666017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682071251931666019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682070416295666017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682071659905666019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682068851307666016)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682071996959666019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(4682069249204666016)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(9379543754960795976)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'46820739'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100000
,p_report_columns=>'OFFLINE_FILE:ACTIVE:VERSION_:FILE_NAME:SET_AS_ACTIVE:DELETE_:LAST_DOWNLOAD:TOTAL_DOWNLOADS:INSERTED_AT:INSERTED_BY:CHANGED_AT:CHANGED_BY:'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689039434369981375)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'active_n'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689039872413981376)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'active_y'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689040247610981377)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'dml_at'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689040605913981379)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'dml_by'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689041052997981379)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'ins_at'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689041455543981380)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
,p_name=>'ins_by'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689041820009981380)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(4689042240936981380)
,p_report_id=>wwv_flow_api.id(9379543754960795976)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9367971731983132113)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4682077869298666042)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(9367971731983132113)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4682078289752666044)
,p_name=>'P7200_FILE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(9367971731983132113)
,p_prompt=>'Zip file'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4682078639673666048)
,p_name=>'P7200_ACTIVE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(9367971731983132113)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4682079051077666048)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4682079578968666052)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(4682078289752666044)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(4682081017776666053)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682081578652666054)
,p_event_id=>wwv_flow_api.id(4682081017776666053)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682082005542666055)
,p_event_id=>wwv_flow_api.id(4682081017776666053)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682082523524666055)
,p_event_id=>wwv_flow_api.id(4682081017776666053)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682083055508666055)
,p_event_id=>wwv_flow_api.id(4682081017776666053)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682083574799666055)
,p_event_id=>wwv_flow_api.id(4682081017776666053)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_api.id(9367970674456132103)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(4682083951938666055)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682085982884666057)
,p_event_id=>wwv_flow_api.id(4682083951938666055)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682084455561666056)
,p_event_id=>wwv_flow_api.id(4682083951938666055)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682084965695666056)
,p_event_id=>wwv_flow_api.id(4682083951938666055)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(4682085479529666056)
,p_event_id=>wwv_flow_api.id(4682083951938666055)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4682079857418666052)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4682080273279666053)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4682080614037666053)
