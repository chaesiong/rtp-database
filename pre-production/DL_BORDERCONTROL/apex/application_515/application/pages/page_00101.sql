...
'}',
''))
,p_step_template=>wwv_flow_api.id(71722077341297067)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(111957095384804981)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99803843824740471)
,p_plug_name=>'Version Number'
,p_parent_plug_id=>wwv_flow_api.id(111957095384804981)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(111957179421804982)
,p_plug_name=>'Login'
,p_parent_plug_id=>wwv_flow_api.id(111957095384804981)
,p_region_template_options=>'#DEFAULT#:t-Form--xlarge'
,p_plug_template=>wwv_flow_api.id(71735390555297142)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(111957356833804983)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(124022375019891870)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(98307858168842770)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(111957179421804982)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98307205049842761)
,p_name=>'P101_MODULE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(111957095384804981)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98308269334842771)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(111957179421804982)
,p_prompt=>'username'
...
,p_field_template=>wwv_flow_api.id(71760840788297224)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98308644359842773)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98310074793842783)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98309651244842782)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98310846811842784)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98310456347842783)
,p_process_sequence=>10
