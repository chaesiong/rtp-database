...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(66646973594198523)
,p_theme_id=>42
,p_name=>'Vista'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(66647361910198525)
,p_theme_id=>42
,p_name=>'Vita'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(66647773979198526)
,p_theme_id=>42
,p_name=>'Vita - Dark'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(66648174603198526)
,p_theme_id=>42
,p_name=>'Vita - Red'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(66648570624198527)
,p_theme_id=>42
,p_name=>'Vita - Slate'
,p_is_current=>false
,p_is_public=>true
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71861482234349897)
,p_theme_id=>500
,p_name=>'DERMALOG'
,p_is_current=>false
,p_is_public=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71861628542349897)
,p_theme_id=>500
,p_name=>'Mull_Spezial'
,p_is_current=>true
,p_is_public=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71861803665349920)
,p_theme_id=>500
,p_name=>'Vista'
,p_css_file_urls=>'#THEME_IMAGES#css/Vista#MIN#.css?v=#APEX_VERSION#'
,p_is_current=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71862064642349920)
,p_theme_id=>500
,p_name=>'Vita'
,p_is_current=>false
,p_is_public=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71862237496349920)
,p_theme_id=>500
,p_name=>'Vita (Copy)'
,p_is_current=>false
,p_is_public=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71862417614349920)
,p_theme_id=>500
,p_name=>'Vita - Slate'
,p_is_current=>false
,p_is_public=>false
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(71862603590349921)
,p_theme_id=>500
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(98344190557923227)
,p_theme_id=>42
,p_name=>'Vita (Copy)'
