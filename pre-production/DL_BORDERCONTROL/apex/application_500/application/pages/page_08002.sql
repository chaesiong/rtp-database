...
,p_last_upd_yyyymmddhh24miss=>'20190809191700'
);
...
'	AND ins_borderpost = (SELECT key_value FROM dl_staging4pibics_intf.trcd_borderpost WHERE seqno = :P8002_DEPT_3)',
'	AND',
'	(',
...
'		:P8002_RETURN := -1;',
'END;'))
,p_attribute_02=>'P8002_SCOPE,P8002_DIRECTION,P8002_VEHICLE_NO,P8002_BORDERPOST,P8002_TRAVEL_DATE,P8002_TRAVEL_TIME_HR_FROM,P8002_TRAVEL_TIME_MIN_FROM,P8002_TRAVEL_TIME_HR_TO,P8002_TRAVEL_TIME_MIN_TO,P8002_DEPT_3'
