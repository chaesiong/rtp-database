...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(102577797005268635)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(102655108325894011)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087350225763512)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087413206763513)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087472735763514)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087626193763515)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087680902763516)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087802191763517)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087953868763518)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113087999771763519)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113088059945763520)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(113088164532763521)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109391863756633128)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(106393843464307504)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109392000526633129)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(109391863756633128)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109392114495633130)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102577955888268636)
,p_name=>'P10_RECORD_NO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
,p_prompt=>'Record No.:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102577959130268637)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578085603268638)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578202174268639)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578309267268640)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578445212268641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578500065268642)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578623272268643)
,p_name=>'P10_GENDER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
,p_prompt=>'Gender:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578830990268645)
,p_name=>'P10_BIRTHDAY'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102578870672268646)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102579000799268647)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102579056605268648)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102653923943893999)
,p_name=>'P10_CASE_NO'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
,p_prompt=>'Case No.:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654034325894000)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654137954894001)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654234137894002)
,p_name=>'P10_REASON'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
,p_prompt=>'Reason:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654310618894003)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654425462894004)
,p_name=>'P10_PHONE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(102577797005268635)
,p_prompt=>'Phone:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654502598894005)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654598516894006)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654734835894007)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102654814512894008)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(113088394585763523)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(109392000526633129)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(113088523283763524)
,p_event_id=>wwv_flow_api.id(113088394585763523)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(113088565296763525)
,p_name=>'Cancel Dialog'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(109392114495633130)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(113088696551763526)
,p_event_id=>wwv_flow_api.id(113088565296763525)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(96998504511571758)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(96998662143571759)
,p_event_id=>wwv_flow_api.id(96998504511571758)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(113088267535763522)
