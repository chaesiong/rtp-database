...
,p_last_upd_yyyymmddhh24miss=>'20190709162013'
);
...
,p_button_condition=>'P7005_TARGET_PAGE'
,p_button_condition_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4683851359900328606)
,p_branch_name=>'Go To P7005_TARGET_PAGE'
,p_branch_action=>'BEGIN'||wwv_flow.LF||
'    RETURN REPLACE(:P7005_TARGET_PAGE, ''~'', '':'');'||wwv_flow.LF||
'END;'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_FUNCTION_RETURNING_URL'
,p_branch_sequence=>10
,p_branch_condition_type=>'ITEM_IS_NOT_NULL'
,p_branch_condition=>'P7005_TARGET_PAGE'
);
wwv_flow_api.create_page_branch(
