...
'}',
''))
,p_step_template=>wwv_flow_api.id(68638050548327473)
...
,p_last_upd_yyyymmddhh24miss=>'20180529144026'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90521324131013788)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90521436027013789)
,p_plug_name=>'Thai Police Logo'
,p_region_name=>'loginAppLogo'
,p_parent_plug_id=>wwv_flow_api.id(90521324131013788)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90521475967013790)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99952948477749800)
,p_plug_name=>'Login'
,p_region_name=>'loginRegion'
,p_parent_plug_id=>wwv_flow_api.id(90521324131013788)
,p_region_template_options=>'#DEFAULT#:t-Form--xlarge'
,p_region_attributes=>'style="border: none !important; border-radius: 0px !important; box-shadow: none !important;"'
,p_plug_template=>wwv_flow_api.id(68675913299327573)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(67733136386322565)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(99952948477749800)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(67731809565322555)
,p_name=>'P101_MODULE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(90521324131013788)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(67733468309322567)
,p_name=>'P101_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(99952948477749800)
,p_prompt=>'username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(67733843031322570)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(67734656753322573)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(67734332863322572)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(67735488766322575)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(67735103607322574)
,p_process_sequence=>10
