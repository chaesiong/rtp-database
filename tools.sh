...
TABLESPACES="BIOSTORE BIOSTORE_IDX BPM DATASTORE DATASTORE_IDX DATASTORE_LOG DATASTORE_LOG_IDX PIBICSAPP TS_AFIS TS_BIO_BD TS_PIBICS TS_PIBICSDM TS_PIBICSDM_IDX TS_SERVAPP TS_SERVAPP_IDX TS_SERVAPP_LOG WEBSERVICE_TBS"
LOBTABLESPACES="BIOSTORE_LOB DATASTORE_LOB DATASTORE_LOB_01 DATASTORE_LOB_02 DATASTORE_LOB_03 DATASTORE_LOB_04 DATASTORE_LOB_05 DATASTORE_LOB_06 DATASTORE_LOB_07 DATASTORE_LOB_08 DATASTORE_LOB_09 TS_SERVAPP_LOB"
