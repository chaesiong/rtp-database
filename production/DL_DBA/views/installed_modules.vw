CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_DBA"."INSTALLED_MODULES" ("TITLE", "MAJOR", "MINOR", "PATCH", "DML_AT") AS 
  ...
  GRANT SELECT ON "DL_DBA"."INSTALLED_MODULES" TO "APPSUP";
  GRANT SELECT ON "DL_DBA"."INSTALLED_MODULES" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_DBA"."INSTALLED_MODULES" TO "BIOSUPPORT";
