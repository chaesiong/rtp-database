...
start_date=>TO_TIMESTAMP_TZ('14-AUG-2019 08.55.00.000000000 AM +07:00','DD-MON-RRRR HH.MI.SSXFF AM TZR','NLS_DATE_LANGUAGE=english'), repeat_interval=> 
NULL
, end_date=>NULL,
...
dbms_scheduler.enable('"J_SEND_TO_PIBICS_UNSUCCESS_2"');
COMMIT; 
END; 
/
