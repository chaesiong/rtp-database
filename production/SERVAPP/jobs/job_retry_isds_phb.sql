BEGIN 
dbms_scheduler.create_job('"JOB_RETRY_ISDS_PHB"',
...
begin
   ...
   v_end:=to_char(sysdate,''DD/MM/YYYY'')||'' 23:59:59'';
             ...
             --Owner :   Tanat + Nitat
            PKG_ISDS_RETRY.ISDS_RETRY(''PHB'',v_start,v_end);         
