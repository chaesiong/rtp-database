...
UPDATE MSCS_REPS_TM8 SET IMG_PERSON=IMG_PERSON_VAL,IMGINOUT=IMGINOUT_VAL WHERE TM8_SEQNO=TM8_SEQNO_VAL;
...
UPDATE MSCS_REPS_PERSON_TMP SET IMG_PERSON=IMG_PERSON_VAL
...
SELECT  FEES_SEQNO_VAL, TM8_SEQNO_VAL--FEESNO_VAL
  ...
  ,SAVE_DATE_VAL FEESLIPDATE, FEESLIPTOTAL_VAL
   ,'Y'-- f.PRINTFLAG
   , DEPT_SEQNO_VAL
   , f.CPASSPORTNO, f.TM6NO, f.FIRSTNM, f.MIDDLENM, f.FAMILYNM, f.SEX, TO_DATE(f.BIRTH_DATE,'DD/MM/YYYY') 
   , f.NATIONAL_SEQNO
...
SELECT  FEES_SEQNO_VAL as FEES_SEQNO, TM8_SEQNO_VAL as FEESNO
  ...
  ,SAVE_DATE_VAL as  FEESLIPDATE, FEESLIPTOTAL_VAL as FEESLIPTOTAL
   ...
   , f.MIDDLENM as EMIDDLENM, f.FAMILYNM as EFAMILYNM, f.SEX
    , TO_DATE(f.BIRTH_DATE,'DD/MM/YYYY')  as BIRTHDTE
