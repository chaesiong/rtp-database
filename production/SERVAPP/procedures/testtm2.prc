CREATE OR REPLACE EDITIONABLE PROCEDURE "SERVAPP"."TESTTM2" (
   p_id     IN number,
        p_mode     IN varchar2,
        p_message   OUT CLOB
) AS 
...
select a.tm2_seqno as bioPk
       ...
       ,a.IODEPT 
       ,to_char(a.IODTE,'yyyymmddhh24miss') as inOutDate
       ,a.IONOTE
...
select JSON_OBJECT (
                   'headerInfo' VALUE (select JSON_OBJECT (
                                               ...
                                               'userID' VALUE 'bio.test.all',
                                               'systemCode' VALUE 'BIO',
                                               'module' VALUE 'TM2',
                                               'ipClient' VALUE '192.168.99.36'
                                               )
                                        from dual),
                   'recordInfo' value (
                                      select JSON_OBJECT (
                                               ...
                                               ,'saveIpClient' value '192.168.99.36'
                                               )
                                        from obj_data
                                       ),
                  'tm2Info' value (
   ...
   v_dml_type :='I';
    ...
    into i_pibicspk
     ...
     v_service_name := 'addTm2ToPibics';
      ...
      v_url :='http://172.22.6.12:8080/bioservice_uat' ||'/rest/isds/tm2/'||v_service_name;
