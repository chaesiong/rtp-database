CREATE TABLE "SERVAPP"."MSCS_EXT_MOVESTAMP" 
  ...
  ;
CREATE UNIQUE INDEX "SERVAPP"."SYS_IL0000377697C00058$$" ON "SERVAPP"."MSCS_EXT_MOVESTAMP" (
  ;
CREATE UNIQUE INDEX "SERVAPP"."SYS_IL0000377697C00059$$" ON "SERVAPP"."MSCS_EXT_MOVESTAMP" (
  ;
  GRANT SELECT ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "PIBICSAPP";
  GRANT ALTER ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT DELETE ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT INDEX ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT INSERT ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT UPDATE ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT REFERENCES ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT READ ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT DEBUG ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
  GRANT FLASHBACK ON "SERVAPP"."MSCS_EXT_MOVESTAMP" TO "BIOSAADM";
