CREATE TABLE "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" 
 ...
 PARTITION "P202012"  VALUES LESS THAN (TIMESTAMP' 2021-01-01 00:00:00') ) ;
  ALTER TABLE "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" ADD CONSTRAINT "MSCS_FS_FEESDETAIL_LOG_$PK" PRIMARY KEY ("FD_LOG_SEQNO", "CREATE_DATE")
  USING INDEX  LOCAL
 (PARTITION "P202001" , 
 PARTITION "P202002" , 
 PARTITION "P202003" , 
 ...
 PARTITION "P202012" )  ENABLE;
  CREATE INDEX "SERVAPP"."MSCS_FS_FEESDETAIL_LOG_IDX01" ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" ("CREATE_DATE") 
   LOCAL
 (PARTITION "P202001" , 
 PARTITION "P202002" , 
 PARTITION "P202003" , 
 ...
 PARTITION "P202011" , 
 PARTITION "P202012" ) ;
CREATE UNIQUE INDEX "SERVAPP"."MSCS_FS_FEESDETAIL_LOG_$PK" ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" ("FD_LOG_SEQNO", "CREATE_DATE") 
   LOCAL
 (PARTITION "P202001" , 
 PARTITION "P202002" , 
 PARTITION "P202003" , 
 ...
 PARTITION "P202011" , 
 PARTITION "P202012" ) ;
  GRANT ALTER ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT DELETE ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT INDEX ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT INSERT ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT UPDATE ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT REFERENCES ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT READ ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT DEBUG ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT FLASHBACK ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."MSCS_FS_FEESDETAIL_LOG" TO "PIBICSAPP";
