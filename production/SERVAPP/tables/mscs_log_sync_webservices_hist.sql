CREATE TABLE "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" 
 ...
 PARTITION "P202012"  VALUES LESS THAN (TO_DATE(' 2021-01-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN')) ) ;
  CREATE INDEX "SERVAPP"."MSCS_LOG_SYNC_WEB_HIST_I1" ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" ("KEY_VALUE") 
   LOCAL
 (PARTITION "P201911" , 
 PARTITION "P201912" , 
 PARTITION "P202001" , 
 ...
 PARTITION "P202011" , 
 PARTITION "P202012" ) ;
CREATE INDEX "SERVAPP"."MSCS_LOG_SYNC_WEB_HIST_I2" ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" ("DML_AT") 
   LOCAL
 (PARTITION "P201911" , 
 PARTITION "P201912" , 
 PARTITION "P202001" , 
 ...
 PARTITION "P202011" , 
 PARTITION "P202012" ) ;
CREATE INDEX "SERVAPP"."MSCS_LOG_SYNC_WEB_HIST_I3" ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" ("INS_AT") 
   LOCAL
 (PARTITION "P201911" , 
 PARTITION "P201912" , 
 PARTITION "P202001" , 
 ...
 PARTITION "P202011" , 
 PARTITION "P202012" ) ;
  GRANT ALTER ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT DELETE ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT INDEX ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT INSERT ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT UPDATE ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT REFERENCES ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT READ ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT DEBUG ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT FLASHBACK ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."MSCS_LOG_SYNC_WEBSERVICES_HIST" TO "PIBICSAPP";
