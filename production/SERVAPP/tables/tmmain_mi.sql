CREATE TABLE "SERVAPP"."TMMAIN_MI" 
  ...
  CREATE UNIQUE INDEX "SERVAPP"."SYS_IL0000377646C00143$$" ON "SERVAPP"."TMMAIN_MI" (
  ;
CREATE UNIQUE INDEX "SERVAPP"."SYS_IL0000377646C00144$$" ON "SERVAPP"."TMMAIN_MI" (
  ;
CREATE UNIQUE INDEX "SERVAPP"."SYS_IL0000377646C00145$$" ON "SERVAPP"."TMMAIN_MI" (
  ;
  GRANT SELECT ON "SERVAPP"."TMMAIN_MI" TO "PIBICSAPP";
  GRANT ALTER ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT DELETE ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT INDEX ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT INSERT ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT SELECT ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT UPDATE ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT REFERENCES ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT READ ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT DEBUG ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
  GRANT FLASHBACK ON "SERVAPP"."TMMAIN_MI" TO "BIOSAADM";
