...
CREATE UNIQUE INDEX "DL_BLACKLIST"."SYS_IL0000312625C00005$$" ON "DL_BLACKLIST"."IMAGES" (
  ...
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT DELETE ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT INDEX ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."IMAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."IMAGES" TO "PUNYAWII_D";
