...
CREATE UNIQUE INDEX "DL_BLACKLIST"."FACES_PK" ON "DL_BLACKLIST"."FACES" ("ID") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT DELETE ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT INDEX ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."FACES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."FACES" TO "PUNYAWII_D";
