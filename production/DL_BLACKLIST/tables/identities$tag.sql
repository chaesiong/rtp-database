CREATE TABLE "DL_BLACKLIST"."IDENTITIES$TAG" 
  ...
  GRANT ALTER ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT DELETE ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT INDEX ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES$TAG" TO "PUNYAWII_D";
