...
CREATE UNIQUE INDEX "DL_BLACKLIST"."FINGER_POSITIONS_PK" ON "DL_BLACKLIST"."FINGER_POSITIONS" ("ID") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS" TO "PUNYAWII_D";
