...
CREATE INDEX "DL_BLACKLIST"."IDENTITIES$IX92" ON "DL_BLACKLIST"."IDENTITIES" ("DML_AT") 
  ;
CREATE INDEX "DL_BLACKLIST"."IDENTITIES_IDX01" ON "DL_BLACKLIST"."IDENTITIES" ("NATIONALITY", "DATE_OF_BIRTH", "SEX") 
  ;
CREATE INDEX "DL_BLACKLIST"."IDENTITIES_IDX02" ON "DL_BLACKLIST"."IDENTITIES" ("NATIONALITY", "DATE_OF_BIRTH") 
  ;
...
CREATE UNIQUE INDEX "DL_BLACKLIST"."SYS_IL0000523049C00044$$" ON "DL_BLACKLIST"."IDENTITIES" (
  ...
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "PIBICSDM2";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."IDENTITIES" TO "PUNYAWII_D";
