...
CREATE UNIQUE INDEX "DL_BLACKLIST"."BLACKLIST_CASE_UK_AUTHORITY_CASE_NUMBER_O" ON "DL_BLACKLIST"."BLACKLIST_CASES_O" ("AUTHORITY", "CASE_NUMBER", "CASE_TYPE") 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_O" TO "PUNYAWII_D";
