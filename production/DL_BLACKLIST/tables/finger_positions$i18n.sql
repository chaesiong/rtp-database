CREATE TABLE "DL_BLACKLIST"."FINGER_POSITIONS$I18N" 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT DELETE ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT INDEX ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."FINGER_POSITIONS$I18N" TO "PUNYAWII_D";
