  ...
  SELECT INC.ID AS FOUNDBLID,
          ...
          (SELECT NUM_VALUE
            ...
            WHERE HS.ICAO = BID.SEX)
             AS GenderNo,
          CASE WHEN UPPER(BID.SEX) = 'FEMALE' THEN 'F'
                     WHEN UPPER(BID.SEX) = 'MALE' THEN 'M'
                         ELSE UPPER(BID.SEX) END AS GenderCode,
