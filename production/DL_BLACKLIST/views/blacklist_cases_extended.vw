...
;
  ...
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."BLACKLIST_CASES_EXTENDED" TO "PUNYAWII_D";
