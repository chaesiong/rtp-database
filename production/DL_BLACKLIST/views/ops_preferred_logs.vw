...
;
  ...
  GRANT DELETE ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_BLACKLIST"."OPS_PREFERRED_LOGS" TO "BIOSAADM";
