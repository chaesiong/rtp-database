CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_BLACKLIST"."VW_FOUNDBLACKLIST" ("FOUNDBLID", "OFFICER", "BLACKLIST_ID", "REASON_CODE", "REASON", "NOTICE", "TRANSACTIONDATE", "GENDERNO", "GENDERCODE", "GENDERNAMETH", "GENDERNAMEEN", "GENDERRPTSEQNO", "DOCUMENTNUMBER", "FIRSTNAMETH", "MIDNAMETH", "FAMILYNAMETH", "FIRSTNAMEEN", "MIDNAMEEN", "FAMILYNAMEEN", "INCIDENTFIRSTNAMEEN", "INCIDENTFAMILYNAMEEN", "INCIDENTBIRTHDATE", "BIRTHDATE", "COUNTRYNO", "COUNTRYCODE", "COUNTRYNAMEABBR", "NATIONALITYTH", "NATIONALITYNAMEEN", "COUNTRYNAMETH", "COUNTRYNAMEEN", "COUNTRYRPTSEQNO", "CONTINENTNAMETH", "CONTINENTNAMEEN", "TRAVELDOCTYPENO", "TRAVELDOCTYPECODE", "TRAVELDOCTYPENAMETH", "TRAVELDOCTYPENAMEEN", "TRAVELDOCTYPERPTSEQNO", "VISATYPECODE", "VISATYPETH", "VISATYPENAMEEN", "PERMITTDAYS", "VISATYPERPTSEQNO", "DEPARTMENTNO", "STATUS", "CREATEDATE", "UPDATEDATE", "BLACKLISTCREATEDATE", "BLACKLISTUPDATEDATE", "TM6", "WLCD", "DIRECTION", "IS_FINISHED") AS 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "APPSUP";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSUPPORT";
  GRANT DELETE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST" TO "BIOSAADM";
