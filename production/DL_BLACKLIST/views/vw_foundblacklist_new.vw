  ...
  SELECT INC.ID AS FOUNDBLID,
     ...
     FROM DL_BORDERCONTROL.INCIDENTS INC
          INNER JOIN DL_BORDERCONTROL.MOVEMENTS MV
             ON INC.MVMNTID = MV.MVMNTID
          INNER JOIN DL_BORDERCONTROL.BORDERDOCUMENTS BD
             ON MV.BRDDOCID = BD.BRDDOCID
          LEFT JOIN DL_BORDERCONTROL.ENTRY_FORMS EF
             ON MV.ENTRY_FORM = EF.KEY_VALUE
          LEFT JOIN DL_BORDERCONTROL.VISAS VI ON MV.VISA = VI.KEY_VALUE
          LEFT JOIN DL_COMMON.VISA_TYPES VT ON VI.VISA_TYPE = VT.KEY_VALUE
          LEFT JOIN DL_BLACKLIST.IDENTITIES BID
             ON INC.BL_APPROVED_IDENTITY = BID.KEY_VALUE
          LEFT JOIN DL_BLACKLIST.BLACKLIST_CASE_IDENTITIES CI
             ON BID.KEY_VALUE = CI."IDENTITY"
          LEFT JOIN DL_BLACKLIST.BLACKLIST_CASES BC
    ...
    WHERE     INC.BL_ACTION IN ('A', 'C', 'F')
          AND MV.SOURCE_SYSTEM = 1
          AND MV.IS_FINISHED = 'Y'
          AND NVL (MV.DATE_OF_ENTRY, MV.INS_AT) >
                 TO_DATE ('2018-02-11 00:00:00', 'YYYY-MM-DD HH24:MI:SS');
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "APPSUP";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSUPPORT";
  GRANT DELETE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_NEW" TO "PUNYAWII_D";
