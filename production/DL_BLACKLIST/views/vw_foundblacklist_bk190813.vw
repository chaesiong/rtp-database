CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" ("FOUNDBLID", "OFFICER", "BLACKLIST_ID", "REASON_CODE", "REASON", "NOTICE", "TRANSACTIONDATE", "GENDERNO", "GENDERCODE", "GENDERNAMETH", "GENDERNAMEEN", "GENDERRPTSEQNO", "DOCUMENTNUMBER", "FIRSTNAMETH", "MIDNAMETH", "FAMILYNAMETH", "FIRSTNAMEEN", "MIDNAMEEN", "FAMILYNAMEEN", "INCIDENTFIRSTNAMEEN", "INCIDENTFAMILYNAMEEN", "INCIDENTBIRTHDATE", "BIRTHDATE", "COUNTRYNO", "COUNTRYCODE", "COUNTRYNAMEABBR", "NATIONALITYTH", "NATIONALITYNAMEEN", "COUNTRYNAMETH", "COUNTRYNAMEEN", "COUNTRYRPTSEQNO", "CONTINENTNAMETH", "CONTINENTNAMEEN", "TRAVELDOCTYPENO", "TRAVELDOCTYPECODE", "TRAVELDOCTYPENAMETH", "TRAVELDOCTYPENAMEEN", "TRAVELDOCTYPERPTSEQNO", "VISATYPECODE", "VISATYPETH", "VISATYPENAMEEN", "PERMITTDAYS", "VISATYPERPTSEQNO", "DEPARTMENTNO", "STATUS", "CREATEDATE", "UPDATEDATE", "BLACKLISTCREATEDATE", "BLACKLISTUPDATEDATE", "TM6", "WLCD", "DIRECTION") AS 
  ...
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSUPPORT";
  GRANT DELETE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT INSERT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT READ ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "BIOSAADM";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "WORAGON_T";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "PISAN_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "CHAYA_W";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "THANASET_N";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "THASAYA_M";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BLACKLIST"."VW_FOUNDBLACKLIST_BK190813" TO "PUNYAWII_D";
