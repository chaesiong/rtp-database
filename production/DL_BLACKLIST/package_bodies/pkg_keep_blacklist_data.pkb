...
/
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_KEEP_BLACKLIST_DATA" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_KEEP_BLACKLIST_DATA" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_KEEP_BLACKLIST_DATA" TO "BIOSAADM";
