...
END pkg_dl_history;
/
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_DL_HISTORY" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_DL_HISTORY" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_DL_HISTORY" TO "BIOSAADM";
