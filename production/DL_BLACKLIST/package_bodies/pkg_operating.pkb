...
/
  ...
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_OPERATING" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_OPERATING" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_OPERATING" TO "BIOSAADM";
