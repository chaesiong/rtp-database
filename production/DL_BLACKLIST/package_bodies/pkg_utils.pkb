...
/
  ...
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_UTILS" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_UTILS" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BLACKLIST"."PKG_UTILS" TO "BIOSAADM";
