CREATE OR REPLACE EDITIONABLE TYPE "DL_BLACKLIST"."CT_PARTIAL_DATE" AS OBJECT (
--
-- *** ATTRIBUTES ***
--
--
...
/
CREATE OR REPLACE EDITIONABLE TYPE BODY "DL_BLACKLIST"."CT_PARTIAL_DATE" AS
--
-- *** ATTRIBUTES ***
--
--
...
MEMBER FUNCTION getFormatData (  date_format IN VARCHAR2 DEFAULT 'DD.MM.YYYY'
    ...
    ORDER MEMBER FUNCTION func_order(P_PARTIAL_DATE_ORDER CT_PARTIAL_DATE) RETURN INTEGER IS
