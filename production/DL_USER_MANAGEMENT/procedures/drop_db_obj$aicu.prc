...
/
  ...
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AICU" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AICU" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AICU" TO "BIOSAADM";
