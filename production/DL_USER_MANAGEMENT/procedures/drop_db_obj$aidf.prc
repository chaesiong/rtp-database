...
/
  ...
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AIDF" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AIDF" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_USER_MANAGEMENT"."DROP_DB_OBJ$AIDF" TO "BIOSAADM";
