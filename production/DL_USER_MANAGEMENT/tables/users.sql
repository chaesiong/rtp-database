...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."USERS$UQ01" ON "DL_USER_MANAGEMENT"."USERS" ("NATIONAL_ID") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "WORAGON_T";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "PISAN_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "CHAYA_W";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "THANASET_N";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "THASAYA_M";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USERS" TO "SANTIPATN_P";
