...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."GRANTS$UQ00" ON "DL_USER_MANAGEMENT"."GRANTS" ("NAME") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "WORAGON_T";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "PISAN_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "CHAYA_W";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "THANASET_N";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "THASAYA_M";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."GRANTS" TO "SANTIPATN_P";
