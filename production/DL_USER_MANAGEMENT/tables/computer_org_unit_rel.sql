...
CREATE UNIQUE INDEX "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL$UQ01" ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" ("COMPUTER_DN") 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "SOMPORN_K";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "WORAGON_T";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "PISAN_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "CHAYA_W";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "THANASET_N";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "THASAYA_M";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTER_ORG_UNIT_REL" TO "SANTIPATN_P";
