CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_USER_MANAGEMENT"."ORG_UNITS#I18N" ("ID", "NAME", "NAME$DLC", "DESCRIPTION", "DESCRIPTION$DLC", "STREET", "STREET$DLC", "CITY", "CITY$DLC", "STATE_PROVINCE", "STATE_PROVINCE$DLC", "POSTCODE", "POSTCODE$DLC", "COUNTRY", "CONTACT_INFO", "CONTACT_INFO$DLC", "SORT_ORDER", "IS_ACTIVE", "LOCALE", "LOCALE$DLC", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "ROW_FLAG_MASK", "TAG", "ORG_UNITS$RI", "ORG_UNITS$I18N$RI") AS 
  select t1.ID
        ,t1.NAME
        ,t1.NAME           as NAME$DLC
        ,t1.DESCRIPTION
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."ORG_UNITS#I18N" TO "APPSUP";
