CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_USER_MANAGEMENT"."COMPUTERS#I18N" ("ID", "NAME", "NAME$DLC", "DESCRIPTION", "DESCRIPTION$DLC", "DNS_NAME", "SORT_ORDER", "IS_ACTIVE", "LOCALE", "LOCALE$DLC", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "ROW_FLAG_MASK", "TAG", "COMPUTERS$RI", "COMPUTERS$I18N$RI") AS 
  select t1.ID
        ,t1.NAME
        ,t1.NAME          as NAME$DLC
        ,t1.DESCRIPTION
  ...
  GRANT MERGE VIEW ON "DL_USER_MANAGEMENT"."COMPUTERS#I18N" TO "BIOSAADM";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTERS#I18N" TO "PUNYAWII_D";
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."COMPUTERS#I18N" TO "SANTIPATN_P";
