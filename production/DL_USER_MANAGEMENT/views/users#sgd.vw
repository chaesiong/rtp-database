CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_USER_MANAGEMENT"."USERS#SGD" ("ID", "USERNAME", "FIRST_NAME", "LAST_NAME", "MAIL_ADDRESS", "PHONE_NUMBER", "STATE", "PW_HASH", "PW_SALT", "PW_ITERATION_COUNT", "PW_EXPIRATION_DATE", "PW_MUST_BE_CHANGED", "LOCALE", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "ROW_FLAG_MASK", "TAG", "LAST_LOGIN", "BAD_PASSWORD_COUNT", "SET_EXPIRED", "OFFLINE_PIN") AS 
  select t0.ID
        ,t0.USERNAME
        ,t0.FIRST_NAME
        ,t0.LAST_NAME
