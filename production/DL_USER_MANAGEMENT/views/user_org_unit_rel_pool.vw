CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" ("RELATION_SOURCE", "USER_ID_OR_DN", "USER_ID", "USER_DN", "ORG_UNIT_ID_OR_DN", "ORG_UNIT_ID", "ORG_UNIT_DN", "INSERT_DATE", "INSERT_SOURCE", "UPDATE_DATE", "UPDATE_SOURCE") AS 
  ...
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "SOMPORN_K";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "WORAGON_T";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "PISAN_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "CHAYA_W";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "THANASET_N";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "THASAYA_M";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_USER_MANAGEMENT"."USER_ORG_UNIT_REL_POOL" TO "SANTIPATN_P";
