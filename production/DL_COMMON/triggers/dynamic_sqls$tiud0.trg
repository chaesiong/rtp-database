CREATE OR REPLACE EDITIONABLE TRIGGER "DL_COMMON"."DYNAMIC_SQLS$TIUD0" 
  for insert or update or delete on DL_COMMON.DYNAMIC_SQLS
compound trigger
--
  --
  /*******************************************************************************
  ...
  */
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE in DYNAMIC_SQLS.KEY_VALUE%type
                              ,o_OWNER     in DYNAMIC_SQLS.OWNER%type
                              ,n_OWNER     in DYNAMIC_SQLS.OWNER%type
                               --
                               ) is
    --
