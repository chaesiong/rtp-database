CREATE TABLE "DL_COMMON"."ICAO_DC_LIST_ITMS" 
  ...
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."ICAO_DC_LIST_ITMS" TO "SANTIPATN_P";
