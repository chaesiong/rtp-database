...
CREATE UNIQUE INDEX "DL_COMMON"."COUNTRIES$UQ06" ON "DL_COMMON"."COUNTRIES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES" TO "PUNYAWII_D";
