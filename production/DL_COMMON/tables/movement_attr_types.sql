...
CREATE UNIQUE INDEX "DL_COMMON"."MOVEMENT_ATTR_TYPES$UQ00" ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."MOVEMENT_ATTR_TYPES" TO "SANTIPATN_P";
