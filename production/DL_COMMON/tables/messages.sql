...
CREATE UNIQUE INDEX "DL_COMMON"."MESSAGES$PK" ON "DL_COMMON"."MESSAGES" ("MESSAGE_KEY") 
  ...
  GRANT ALTER ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."MESSAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."MESSAGES" TO "SANTIPATN_P";
