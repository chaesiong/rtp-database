...
CREATE UNIQUE INDEX "DL_COMMON"."APEX_MENU$PK" ON "DL_COMMON"."APEX_MENU" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."APEX_MENU" TO "PUNYAWII_D";
