CREATE TABLE "DL_COMMON"."CONTINENTS$HIS" 
  ...
  GRANT ALTER ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."CONTINENTS$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."CONTINENTS$HIS" TO "PUNYAWII_D";
