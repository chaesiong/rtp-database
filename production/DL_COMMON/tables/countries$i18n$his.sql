CREATE TABLE "DL_COMMON"."COUNTRIES$I18N$HIS" 
  ...
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$I18N$HIS" TO "PUNYAWII_D";
