...
CREATE UNIQUE INDEX "DL_COMMON"."APEX_LISTS$PK" ON "DL_COMMON"."APEX_LISTS" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."APEX_LISTS" TO "PUNYAWII_D";
