...
CREATE UNIQUE INDEX "DL_COMMON"."CARRIERS$UQ00" ON "DL_COMMON"."CARRIERS" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."CARRIERS" TO "PUNYAWII_D";
