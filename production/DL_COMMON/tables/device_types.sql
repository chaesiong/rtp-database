...
CREATE UNIQUE INDEX "DL_COMMON"."DEVICE_TYPES$UQ00" ON "DL_COMMON"."DEVICE_TYPES" ("NUM_VALUE") 
  ...
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."DEVICE_TYPES" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."DEVICE_TYPES" TO "PUNYAWII_D";
