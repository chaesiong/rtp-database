CREATE TABLE "DL_COMMON"."STATUSES$HIS" 
  ...
  GRANT ALTER ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."STATUSES$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."STATUSES$HIS" TO "SANTIPATN_P";
