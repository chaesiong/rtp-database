CREATE TABLE "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" 
  ...
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_TYPES$TAG$HIS" TO "PUNYAWII_D";
