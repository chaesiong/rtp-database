CREATE TABLE "DL_COMMON"."VISA_TYPES$HIS" 
  ...
  GRANT ALTER ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT DELETE ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT INDEX ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."VISA_TYPES$HIS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."VISA_TYPES$HIS" TO "SANTIPATN_P";
