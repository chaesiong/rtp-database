CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."CARD_TYPES#TAG" ("KEY_VALUE", "LOCALE", "DISPLAY_VALUE", "DISPLAY_ORDER", "IS_ACTIVE", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "NOTICE", "NUM_VALUE", "ROW_FLAG_MASK", "OWNER", "TAG", "NOTICE$TAG", "INS_AT$TAG", "INS_BY$TAG", "DML_AT$TAG", "DML_BY$TAG", "DML_TYPE$TAG", "ROW_FLAG_MASK$TAG", "OWNER$TAG", "CARD_TYPES$RI", "CARD_TYPES$TAG$RI") AS 
  select t1.KEY_VALUE
        ,t1.LOCALE
        ,t1.DISPLAY_VALUE
        ,t1.DISPLAY_ORDER
        ...
        ,t2.OWNER         as OWNER$TAG
         ...
         ,t2.rowid            as CARD_TYPES$TAG$RI
    from DL_COMMON.CARD_TYPES t1
    left join DL_COMMON.CARD_TYPES$TAG t2
  ...
  GRANT MERGE VIEW ON "DL_COMMON"."CARD_TYPES#TAG" TO "BIOSAADM";
  ...
  GRANT SELECT ON "DL_COMMON"."CARD_TYPES#TAG" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."CARD_TYPES#TAG" TO "PUNYAWII_D";
