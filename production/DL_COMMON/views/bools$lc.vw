CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."BOOLS$LC" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "NOTICE", "NOTICE$DLC", "NUM_VALUE", "BOOLS$RI", "BOOLS$I18N$RI") AS 
  ...
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."BOOLS$LC" TO "PUNYAWII_D";
