CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."PORT_MOVEMENTS$LC" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "NOTICE", "NOTICE$DLC", "NUM_VALUE", "IS_NEED_ENTRY_FORM", "ICAO_DC_LIST4NO_ENTRY_FORM", "MUST_APPROVE_ENTRY_FORM_NO", "PORT_MOVEMENTS$RI", "PORT_MOVEMENTS$I18N$RI") AS 
  ...
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."PORT_MOVEMENTS$LC" TO "SANTIPATN_P";
