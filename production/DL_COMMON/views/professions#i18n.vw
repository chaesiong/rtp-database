CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."PROFESSIONS#I18N" ("KEY_VALUE", "DML_AT", "DML_BY", "DML_TYPE", "INS_AT", "INS_BY", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "NAME$DLC", "DISPLAY_CODE", "DISPLAY_ORDER", "IS_ACTIVE", "NOTICE", "PROFESSIONS$RI", "PROFESSIONS$I18N$RI") AS 
  ...
  GRANT DELETE ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_COMMON"."PROFESSIONS#I18N" TO "BIOSAADM";
