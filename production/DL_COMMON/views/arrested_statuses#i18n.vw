CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."ARRESTED_STATUSES#I18N" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "NOTICE", "NOTICE$DLC", "NUM_VALUE", "ROW_FLAG_MASK", "ROW_FLAG_MASK$I18N", "OWNER", "OWNER$I18N", "ARRESTED_STATUSES$RI", "ARRESTED_STATUSES$I18N$RI") AS 
  ...
  select t1.KEY_VALUE
    ...
    from DL_COMMON.ARRESTED_STATUSES t1
   inner join DL_COMMON.ARRESTED_STATUSES$I18N t2
  ...
  GRANT MERGE VIEW ON "DL_COMMON"."ARRESTED_STATUSES#I18N" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_STATUSES#I18N" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."ARRESTED_STATUSES#I18N" TO "PONGPICHET_N";
