CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."COUNTRIES$LC" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "NOTICE", "NOTICE$DLC", "ISO3166_A3", "ISO3166_A2", "ISO3166_NUM", "TL_DOMAIN", "PHONE_AREA_CODE", "ICAO_LOC_PART", "NATIONALITY", "NATIONALITY$DLC", "NUM_VALUE", "ROW_FLAG_MASK", "ROW_FLAG_MASK$I18N", "OFFICIAL_LANGUAGE", "OWNER", "OWNER$I18N", "COUNTRIES$RI", "COUNTRIES$I18N$RI", "ICAO", "COUNTRY") AS 
  ...
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "PUNYAWII_D";
