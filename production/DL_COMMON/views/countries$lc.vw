CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."COUNTRIES$LC" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "NOTICE", "NOTICE$DLC", "ISO3166_A3", "ISO3166_A2", "ISO3166_NUM", "TL_DOMAIN", "PHONE_AREA_CODE", "ICAO_LOC_PART", "NATIONALITY", "NATIONALITY$DLC", "NUM_VALUE", "ROW_FLAG_MASK", "ROW_FLAG_MASK$I18N", "OFFICIAL_LANGUAGE", "OWNER", "OWNER$I18N", "COUNTRIES$RI", "COUNTRIES$I18N$RI", "ICAO", "COUNTRY") AS 
  ...
  GRANT DELETE ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_COMMON"."COUNTRIES$LC" TO "BIOSAADM";
