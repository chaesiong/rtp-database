CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."PORTS$LC" ("KEY_VALUE", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "DISPLAY_VALUE$DLC", "DISPLAY_ORDER", "IS_ACTIVE", "NOTICE", "NOTICE$DLC", "LATITUDE", "LONGITUDE", "ALTITUDE", "COUNTRY", "CITY", "TZ_OFFSET", "TZ_REGION", "TZ_ABBREV", "PORT_TYPE_MASK", "UN_LOCODE", "NUM_VALUE", "IS_SEA_PORT", "IS_AIRPORT", "IS_RAIL_TERMINAL", "IS_ROAD_TERMINAL", "PORTS$RI", "PORTS$I18N$RI") AS 
  ...
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."PORTS$LC" TO "SANTIPATN_P";
