...
from  apex_050100.wwv_flow_sessions$;
  ...
  GRANT DELETE ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT INSERT ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT SELECT ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT READ ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_COMMON"."V_APEX_SESSIONS" TO "BIOSAADM";
