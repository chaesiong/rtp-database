CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_COMMON"."SALUTATIONS#I18N" ("KEY_VALUE", "DML_AT", "DML_BY", "DML_TYPE", "INS_AT", "INS_BY", "LOCALE", "LOCALE$DLC", "DISPLAY_VALUE", "NAME$DLC", "DISPLAY_CODE", "DISPLAY_ORDER", "IS_ACTIVE", "NOTICE", "SALUTATIONS$RI", "SALUTATIONS$I18N$RI") AS 
  ...
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "SOMPORN_K";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "PUNYAWII_D";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "WORAGON_T";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "PISAN_S";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "CHAYA_W";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "THANASET_N";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "THASAYA_M";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_COMMON"."SALUTATIONS#I18N" TO "SANTIPATN_P";
