CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_UT" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_UT" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_UT" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_UT" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_UT" TO "BIOSAADM";
