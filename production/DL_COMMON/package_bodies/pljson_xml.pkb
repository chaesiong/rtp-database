CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_XML" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_XML" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_XML" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_XML" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_XML" TO "BIOSAADM";
