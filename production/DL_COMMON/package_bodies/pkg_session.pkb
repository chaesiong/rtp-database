...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PKG_SESSION" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PKG_SESSION" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PKG_SESSION" TO "BIOSAADM";
