CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_ML" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_ML" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_ML" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_ML" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_ML" TO "BIOSAADM";
