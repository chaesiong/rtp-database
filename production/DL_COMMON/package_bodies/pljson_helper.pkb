CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_HELPER" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_HELPER" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_HELPER" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_HELPER" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_HELPER" TO "BIOSAADM";
