CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_AC" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_AC" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_AC" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_AC" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_AC" TO "BIOSAADM";
