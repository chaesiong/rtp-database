CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_PRINTER" as
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_PRINTER" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_PRINTER" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_PRINTER" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_PRINTER" TO "BIOSAADM";
