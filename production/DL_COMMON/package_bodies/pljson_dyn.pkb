CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DL_COMMON"."PLJSON_DYN" as
/*
  -- 11gR2
...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_DYN" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_DYN" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_DYN" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PLJSON_DYN" TO "BIOSAADM";
