...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."PKG_JSON_CONVERT" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."PKG_JSON_CONVERT" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."PKG_JSON_CONVERT" TO "BIOSAADM";
