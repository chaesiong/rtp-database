CREATE OR REPLACE EDITIONABLE FUNCTION "DL_COMMON"."VALUE4LOOKUPS$IS_ACTIVE" (p_VALID_FROM in date
                                                            ,p_VALID_TO   in date
                                                             --
...
/
  GRANT EXECUTE ON "DL_COMMON"."VALUE4LOOKUPS$IS_ACTIVE" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "DL_COMMON"."VALUE4LOOKUPS$IS_ACTIVE" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."VALUE4LOOKUPS$IS_ACTIVE" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."VALUE4LOOKUPS$IS_ACTIVE" TO "BIOSAADM";
