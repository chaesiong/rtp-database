...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB" TO "BIOSAADM";
