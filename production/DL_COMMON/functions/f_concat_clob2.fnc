...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."F_CONCAT_CLOB2" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_CONCAT_CLOB2" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_CONCAT_CLOB2" TO "BIOSAADM";
