...
/
  ...
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB_BASE64" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB_BASE64" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_COMMON"."F_BLOB_TO_CLOB_BASE64" TO "BIOSAADM";
