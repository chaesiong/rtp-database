CREATE OR REPLACE EDITIONABLE PROCEDURE "LOGGER"."LOGGER_CONFIGURE" 
is
...
/
  GRANT EXECUTE ON "LOGGER"."LOGGER_CONFIGURE" TO "DERMALOG_PROXY";
  GRANT EXECUTE ON "LOGGER"."LOGGER_CONFIGURE" TO "BIOSAADM";
