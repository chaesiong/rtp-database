...
inner join dl_bordercontrol_datamart.dim_borderposts dim_borderposts on dim_borderposts.id = fact.dimension_border_posts_id;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."PIVOT_ANALYSIS" TO "APPSUP";
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."PIVOT_ANALYSIS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."PIVOT_ANALYSIS" TO "BIOSUPPORT";
