CREATE TABLE "DL_BORDERCONTROL_DATAMART"."DIM_NATIONALITY_TIME_MOVEMENT" 
   (	"YEAR_NUMERIC" NUMBER(4,0), 
	"MONTH_NAME" VARCHAR2(53 CHAR), 
	"DATE_VALUE" DATE, 
	"NATIONALITY" VARCHAR2(128 CHAR), 
	"NATIONALITY_ID" VARCHAR2(32 CHAR), 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."DIM_NATIONALITY_TIME_MOVEMENT" TO "APPSUP";
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."DIM_NATIONALITY_TIME_MOVEMENT" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL_DATAMART"."DIM_NATIONALITY_TIME_MOVEMENT" TO "BIOSUPPORT";
