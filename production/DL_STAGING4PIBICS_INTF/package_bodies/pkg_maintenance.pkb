...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_MAINTENANCE" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_MAINTENANCE" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_MAINTENANCE" TO "BIOSAADM";
