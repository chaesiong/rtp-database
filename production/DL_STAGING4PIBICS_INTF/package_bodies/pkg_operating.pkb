...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_OPERATING" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_OPERATING" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PKG_OPERATING" TO "BIOSAADM";
