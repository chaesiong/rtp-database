...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PREPARE_SCHEDULER_AS_SYSTEM" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PREPARE_SCHEDULER_AS_SYSTEM" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."PREPARE_SCHEDULER_AS_SYSTEM" TO "BIOSAADM";
