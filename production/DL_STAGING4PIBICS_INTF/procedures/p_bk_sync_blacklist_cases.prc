...
/
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."P_BK_SYNC_BLACKLIST_CASES" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."P_BK_SYNC_BLACKLIST_CASES" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."P_BK_SYNC_BLACKLIST_CASES" TO "BIOSAADM";
