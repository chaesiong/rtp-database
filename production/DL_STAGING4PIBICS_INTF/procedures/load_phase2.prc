...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."LOAD_PHASE2" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."LOAD_PHASE2" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."LOAD_PHASE2" TO "BIOSAADM";
