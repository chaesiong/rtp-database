...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."KEEP_CURRENT" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."KEEP_CURRENT" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."KEEP_CURRENT" TO "BIOSAADM";
