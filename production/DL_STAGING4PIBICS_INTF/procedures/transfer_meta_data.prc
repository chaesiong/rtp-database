...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."TRANSFER_META_DATA" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."TRANSFER_META_DATA" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS_INTF"."TRANSFER_META_DATA" TO "BIOSAADM";
