...
WHERE rn = 1;
  ...
  GRANT DELETE ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_STAGING4PIBICS_INTF"."SYNC_BLACKLIST_CASES_ERRORS" TO "BIOSAADM";
