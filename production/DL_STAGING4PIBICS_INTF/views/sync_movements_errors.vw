...
WHERE rn = 1;
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS_ERRORS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS_ERRORS" TO "BIOSUPPORT";
