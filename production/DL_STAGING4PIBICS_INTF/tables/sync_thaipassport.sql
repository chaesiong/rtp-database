...
CREATE UNIQUE INDEX "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT_UK2" ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS_INTF"."SYNC_THAIPASSPORT" TO "BIOSAADM";
