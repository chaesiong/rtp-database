CREATE TABLE "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" 
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "APPSUP";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS_INTF"."LOG_RUN_STEPS" TO "BIOSAADM";
