...
CREATE UNIQUE INDEX "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS_PK" ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" ("SEQNO") 
  ...
  GRANT ALTER ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS_INTF"."SYNC_MOVEMENTS" TO "BIOSAADM";
