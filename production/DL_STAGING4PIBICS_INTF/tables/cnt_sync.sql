CREATE TABLE "DL_STAGING4PIBICS_INTF"."CNT_SYNC" 
  ...
  GRANT ALTER ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS_INTF"."CNT_SYNC" TO "BIOSAADM";
