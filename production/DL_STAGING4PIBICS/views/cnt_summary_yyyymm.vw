...
GROUP BY p.table_name
  ...
  GRANT DELETE ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_STAGING4PIBICS"."CNT_SUMMARY_YYYYMM" TO "BIOSAADM";
