...
;
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "APPSUP" WITH GRANT OPTION;
  GRANT SELECT ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSUPPORT";
  GRANT DELETE ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_STAGING4PIBICS"."CNT_SUMMARY" TO "BIOSAADM";
