CREATE OR REPLACE EDITIONABLE PACKAGE "DL_STAGING4PIBICS"."PKG_LOSTPASSPORT" AUTHID DEFINER AS
    ...
    /* Load data from PIBICS.LOSTPASSPORT to DL_STAGING4PIBICS.LOSTPASSPORT */
