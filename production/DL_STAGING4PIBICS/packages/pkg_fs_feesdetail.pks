CREATE OR REPLACE EDITIONABLE PACKAGE "DL_STAGING4PIBICS"."PKG_FS_FEESDETAIL" AUTHID DEFINER AS
    ...
    /* Load data from PIBICS.FS_FEESDETAIL to DL_STAGING4PIBICS.FS_FEESDETAIL */
