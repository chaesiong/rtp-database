...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."MODIFY_PIBICS_LINK" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."MODIFY_PIBICS_LINK" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."MODIFY_PIBICS_LINK" TO "BIOSAADM";
