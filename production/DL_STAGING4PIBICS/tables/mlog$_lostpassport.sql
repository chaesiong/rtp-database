CREATE TABLE "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" 
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."MLOG$_LOSTPASSPORT" TO "BIOSAADM";
