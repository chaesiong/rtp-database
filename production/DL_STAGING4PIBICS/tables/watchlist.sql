CREATE TABLE "DL_STAGING4PIBICS"."WATCHLIST" 
  ...
  ALTER TABLE "DL_STAGING4PIBICS"."WATCHLIST" ADD CONSTRAINT "WATCHLISTNM_PK" PRIMARY KEY ("WLCD", "SEQNO")
  USING INDEX  ENABLE;
  CREATE INDEX "DL_STAGING4PIBICS"."WL_CREDTE_IDX1" ON "DL_STAGING4PIBICS"."WATCHLIST" ("DL_STAGING4PIBICS"."PKG_UTILS"."GET_YYYYMMDD"("CREDTE")) 
  ;
CREATE UNIQUE INDEX "DL_STAGING4PIBICS"."WATCHLISTNM_PK" ON "DL_STAGING4PIBICS"."WATCHLIST" ("WLCD", "SEQNO") 
  ;
  GRANT DELETE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_STAGING4PIBICS_INTF";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_STAGING4PIBICS_INTF";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_STAGING4PIBICS_INTF";
  GRANT DELETE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_COMMON";
  GRANT INSERT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_COMMON";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_COMMON";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DL_COMMON";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "SERVAPP";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIO_BD";
  GRANT DELETE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DERMALOG_PROXY";
  GRANT INSERT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DERMALOG_PROXY";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DERMALOG_PROXY";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "DERMALOG_PROXY";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "APPSUP";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."WATCHLIST" TO "BIOSAADM";
