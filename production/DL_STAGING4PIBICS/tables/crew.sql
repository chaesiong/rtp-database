...
CREATE UNIQUE INDEX "DL_STAGING4PIBICS"."SYS_IL0000312952C00048$$" ON "DL_STAGING4PIBICS"."CREW" (
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS"."CREW" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS"."CREW" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."CREW" TO "BIOSAADM";
