...
CREATE UNIQUE INDEX "DL_STAGING4PIBICS"."TRAVELDOCTYPE_PK" ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" ("TDT_SEQNO") 
  ...
  GRANT SELECT ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "APPSUP";
  GRANT SELECT ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT DELETE ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT INDEX ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT INSERT ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT SELECT ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT UPDATE ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT READ ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT DEBUG ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_STAGING4PIBICS"."TRAVELDOCTYPE" TO "BIOSAADM";
