...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_SYNC_RESIDENTS" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_SYNC_RESIDENTS" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_SYNC_RESIDENTS" TO "BIOSAADM";
