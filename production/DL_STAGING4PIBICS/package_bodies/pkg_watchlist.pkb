...
PROCEDURE merge_WLINDICATECARD_yyyymmdd(p_date IN VARCHAR2) IS
  ...
  BEGIN
    ...
    USING (SELECT distinct wlic.WLCD,  
                  wlic.SEQNO,  
                  wlic.IDCCD,
                  wlic.DOCNO,
                  wlic.ISUDTE,
...
/
  ...
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_WATCHLIST" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_WATCHLIST" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_STAGING4PIBICS"."PKG_WATCHLIST" TO "BIOSAADM";
