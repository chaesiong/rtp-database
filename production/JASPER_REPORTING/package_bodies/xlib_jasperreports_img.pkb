CREATE OR REPLACE EDITIONABLE PACKAGE BODY "JASPER_REPORTING"."XLIB_JASPERREPORTS_IMG" as
/*
...
/
  ...
  GRANT EXECUTE ON "JASPER_REPORTING"."XLIB_JASPERREPORTS_IMG" TO "BIOSAADM";
