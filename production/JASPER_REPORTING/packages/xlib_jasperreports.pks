CREATE OR REPLACE EDITIONABLE PACKAGE "JASPER_REPORTING"."XLIB_JASPERREPORTS" 
AS
/*=========================================================================
  $Id: xlib_jasperreports.pks 69 2017-10-15 16:19:34Z dietmar.aust $
  ...
  $LastChangedDate: 2017-10-15 18:19:34 +0200 (So, 15 Okt 2017) $
...
=========================================================================*/
  ...
  version_c constant varchar2(20 char) := '2.4.0.0';
