CREATE OR REPLACE EDITIONABLE PROCEDURE "DL_INTERFACE"."SP_READY_INVALID_GIVEN_FORMAT" (SENDDATE IN DATE) AS 
...
BEGIN
  ...
  ( SELECT distinct (a.SENDER_OBJECT_ID), 3, null, m.BRDDOCID	
    ...
    AND a.SENDER_RESPONSE_MESSAGE like '%givenName%'
...
END SP_READY_INVALID_GIVEN_FORMAT;
/
