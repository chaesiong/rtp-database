...
/
  ...
  GRANT EXECUTE ON "DL_INTERFACE"."SP_SEND_TO_PIBICS_AGAIN" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."SP_SEND_TO_PIBICS_AGAIN" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."SP_SEND_TO_PIBICS_AGAIN" TO "BIOSAADM";
