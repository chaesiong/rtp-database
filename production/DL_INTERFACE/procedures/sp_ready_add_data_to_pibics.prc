CREATE OR REPLACE EDITIONABLE PROCEDURE "DL_INTERFACE"."SP_READY_ADD_DATA_TO_PIBICS" (SENDDATE IN DATE) AS                      
...
/
  GRANT EXECUTE ON "DL_INTERFACE"."SP_READY_ADD_DATA_TO_PIBICS" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."SP_READY_ADD_DATA_TO_PIBICS" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."SP_READY_ADD_DATA_TO_PIBICS" TO "BIOSAADM";
