...
/
  ...
  GRANT EXECUTE ON "DL_INTERFACE"."PKG_EXCHANGE_OBJECTS" TO "APPSUP";
  GRANT EXECUTE ON "DL_INTERFACE"."PKG_EXCHANGE_OBJECTS" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."PKG_EXCHANGE_OBJECTS" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_INTERFACE"."PKG_EXCHANGE_OBJECTS" TO "BIOSAADM";
