CREATE TABLE "DL_INTERFACE"."PARAMETERS" 
  ...
  GRANT SELECT ON "DL_INTERFACE"."PARAMETERS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_INTERFACE"."PARAMETERS" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT DELETE ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT INDEX ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT INSERT ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT SELECT ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT READ ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_INTERFACE"."PARAMETERS" TO "BIOSAADM";
