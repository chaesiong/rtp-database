CREATE TABLE "PIBICSDM2"."WATCHLISTLOG_RB" 
  ...
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."WATCHLISTLOG_RB" TO "BIOSAADM";
