CREATE TABLE "PIBICSDM2"."EXT_APPEAL" 
  ...
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."EXT_APPEAL" TO "BIOSAADM";
