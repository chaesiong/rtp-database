CREATE TABLE "PIBICSDM2"."TMP_SYNC_MAS_DEPARTMENT" 
   (	"DEPT_SEQNO" NUMBER, 
  ...
  ALTER TABLE "PIBICSDM2"."TMP_SYNC_MAS_DEPARTMENT" ADD CONSTRAINT "TMP_SYNC_MAS_DEPARTMENT_PK" PRIMARY KEY ("DEPT_SEQNO")
  USING INDEX  ENABLE;
  CREATE UNIQUE INDEX "PIBICSDM2"."TMP_SYNC_MAS_DEPARTMENT_PK" ON "PIBICSDM2"."TMP_SYNC_MAS_DEPARTMENT" ("DEPT_SEQNO") 
  ;
