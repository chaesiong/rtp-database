CREATE TABLE "PIBICSDM2"."TMP_SYNC_MAS_POLICESTATION" 
   (	"PLS_SEQNO" NUMBER, 
  ...
  ALTER TABLE "PIBICSDM2"."TMP_SYNC_MAS_POLICESTATION" ADD CONSTRAINT "TMP_SYNC_MAS_POLICESTATION_PK" PRIMARY KEY ("PLS_SEQNO")
  USING INDEX  ENABLE;
  CREATE UNIQUE INDEX "PIBICSDM2"."TMP_SYNC_MAS_POLICESTATION_PK" ON "PIBICSDM2"."TMP_SYNC_MAS_POLICESTATION" ("PLS_SEQNO") 
  ;
