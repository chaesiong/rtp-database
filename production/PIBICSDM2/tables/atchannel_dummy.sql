...
CREATE UNIQUE INDEX "PIBICSDM2"."ATCHANNEL_DUMMY_PK" ON "PIBICSDM2"."ATCHANNEL_DUMMY" ("SEQNO") 
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000300803C00044$$" ON "PIBICSDM2"."ATCHANNEL_DUMMY" (
  ;
  ...
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."ATCHANNEL_DUMMY" TO "BIOSAADM";
