...
CREATE INDEX "PIBICSDM2"."TMINFORMDEAD_TM6NO_IDX" ON "PIBICSDM2"."TMINFORMDEAD" ("TM6NO") 
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000302087C00042$$" ON "PIBICSDM2"."TMINFORMDEAD" (
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."TMINFORMDEAD_PK" ON "PIBICSDM2"."TMINFORMDEAD" ("TMINFDEADSEQNO") 
  ...
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."TMINFORMDEAD" TO "BIOSAADM";
