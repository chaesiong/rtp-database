...
CREATE UNIQUE INDEX "PIBICSDM2"."REPS_TM8_PK" ON "PIBICSDM2"."REPS_TM8" ("TM8_SEQNO") 
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000301885C00056$$" ON "PIBICSDM2"."REPS_TM8" (
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000301885C00070$$" ON "PIBICSDM2"."REPS_TM8" (
  ;
  ...
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."REPS_TM8" TO "BIOSAADM";
