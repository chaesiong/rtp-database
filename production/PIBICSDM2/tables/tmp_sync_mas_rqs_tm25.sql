CREATE TABLE "PIBICSDM2"."TMP_SYNC_MAS_RQS_TM25" 
   (	"TM25_SEQNO" NUMBER, 
  ...
  ALTER TABLE "PIBICSDM2"."TMP_SYNC_MAS_RQS_TM25" ADD CONSTRAINT "TMP_SYNC_MAS_RQS_TM25_PK" PRIMARY KEY ("TM25_SEQNO")
  USING INDEX  ENABLE;
  CREATE UNIQUE INDEX "PIBICSDM2"."TMP_SYNC_MAS_RQS_TM25_PK" ON "PIBICSDM2"."TMP_SYNC_MAS_RQS_TM25" ("TM25_SEQNO") 
  ;
