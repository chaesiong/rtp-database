CREATE TABLE "PIBICSDM2"."EXTENSION90N2_TMP" 
  ...
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."EXTENSION90N2_TMP" TO "BIOSAADM";
