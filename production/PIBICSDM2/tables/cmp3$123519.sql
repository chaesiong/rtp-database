CREATE TABLE "PIBICSDM2"."CMP3$123519" 
  ...
  CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000300901C00091$$" ON "PIBICSDM2"."CMP3$123519" (
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000300901C00092$$" ON "PIBICSDM2"."CMP3$123519" (
  ;
  ...
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."CMP3$123519" TO "BIOSAADM";
