...
CREATE INDEX "PIBICSDM2"."TIMM_VISATYPE_SEQNO2" ON "PIBICSDM2"."IMMIGRATION_TMP" ("VISATYPE_SEQNO") 
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000301472C00026$$" ON "PIBICSDM2"."IMMIGRATION_TMP" (
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000301472C00028$$" ON "PIBICSDM2"."IMMIGRATION_TMP" (
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."TIMMIGRATION_TMP_PK2" ON "PIBICSDM2"."IMMIGRATION_TMP" ("PERSONID") 
  ...
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."IMMIGRATION_TMP" TO "BIOSAADM";
