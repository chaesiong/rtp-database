...
CREATE INDEX "PIBICSDM2"."TMINOUT_MA_IDX2" ON "PIBICSDM2"."TMINOUT_MA" (TRIM("TFIRSTNM"), TRIM("TFAMILYNM")) 
  ;
CREATE INDEX "PIBICSDM2"."TMINOUT_MA_IDX20" ON "PIBICSDM2"."TMINOUT_MA" (TRIM("EFAMILYNM")) 
  ;
CREATE INDEX "PIBICSDM2"."TMINOUT_MA_IDX21" ON "PIBICSDM2"."TMINOUT_MA" (TRIM("TFAMILYNM")) 
  ;
...
CREATE UNIQUE INDEX "PIBICSDM2"."SEQNO_PK" ON "PIBICSDM2"."TMINOUT_MA" ("SEQNO") 
  ;
CREATE UNIQUE INDEX "PIBICSDM2"."SYS_IL0000302114C00044$$" ON "PIBICSDM2"."TMINOUT_MA" (
  ;
  ...
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "ROLE_SERVAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "ROLE_PIBICSDM2_RO";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "ROLE_DL_STAGING4PIBICS";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSUPPORT";
  GRANT ALTER ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT DELETE ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT INDEX ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."TMINOUT_MA" TO "BIOSAADM";
