CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_DELPROCESSOT" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('DELPROCESSOT_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('DELPROCESSOT_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_DELPROCESSOT;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_DELPROCESSOT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_DELPROCESSOT" TO "BIOSAADM";
