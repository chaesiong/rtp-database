CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_FS_FINESDETAIL_M" (v_dstart varchar2,v_dend varchar2)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FS_FINESDETAIL_C_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FS_FINESDETAIL_C_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FS_FINESDETAIL_U_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FS_FINESDETAIL_U_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
EXCEPTION
   ...
   THEN
      ...
      RAISE;
END P_FS_FINESDETAIL_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_FS_FINESDETAIL_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_FS_FINESDETAIL_M" TO "BIOSAADM";
