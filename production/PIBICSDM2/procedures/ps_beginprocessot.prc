CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PS_BEGINPROCESSOT" IS
tmpVar NUMBER;
BEGIN
    DECLARE
    ...
    CURSOR c1 IS
        ...
        select * from ext_person where (to_number(to_char(create_date, 'yyyymmdd')) >= 20170101) and approve_sts = 'A' 
    ...
    END;
END PS_BEGINPROCESSOT;
/
  GRANT EXECUTE ON "PIBICSDM2"."PS_BEGINPROCESSOT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PS_BEGINPROCESSOT" TO "BIOSAADM";
