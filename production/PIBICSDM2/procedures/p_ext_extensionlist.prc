CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_EXT_EXTENSIONLIST" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_EXTENSIONLIST_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_EXTENSIONLIST_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_EXTENSIONLIST_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_EXTENSIONLIST_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
EXCEPTION
   ...
   THEN
      ...
      RAISE;
END P_EXT_EXTENSIONLIST;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_EXTENSIONLIST" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_EXTENSIONLIST" TO "BIOSAADM";
