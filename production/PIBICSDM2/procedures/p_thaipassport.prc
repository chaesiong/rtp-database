CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_THAIPASSPORT" 
IS
...
BEGIN
 ...
 MERGE INTO PIBICSDM2.THAIPASSPORT DM
  ...
  ON (DM.PASSPORTNO = P.PASSPORTNO AND DM.CITIZENID = P.CITIZENID)
 WHEN MATCHED 
 THEN 
  UPDATE SET      
 ...
 INSERT INTO IMPORT_LOG_DETAIL VALUES ('THAIPASSPORT_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.CITIZENID,
 ...
 INSERT INTO IMPORT_LOG   VALUES ('THAIPASSPORT_U', var_rows, SYSDATE);
 
 veddate :=sysdate;
 
 INSERT INTO IMPORT_LOG_DETAIL VALUES ('THAIPASSPORT_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_THAIPASSPORT;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_THAIPASSPORT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_THAIPASSPORT" TO "BIOSAADM";
