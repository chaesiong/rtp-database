CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHK_BLACKLIST_TEST2" 
...
begin
               ...
               FROM V_watchlist_prod W, V_WATCHLISTNM_PROD WN, V_WLINDICATECARD_PROD  WC
...
END P_CHK_BLACKLIST_Test2;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST2" TO "BIOSAADM";
