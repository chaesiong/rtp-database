CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHNG_CHANGEVISALIST_M" (v_dstart varchar2,v_dend varchar2)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
BEGIN
  ...
  -- v_dend := TO_CHAR (TRUNC (SYSDATE), 'yyyymmdd');
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('CHNG_CHANGEVISALIST_C_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('CHNG_CHANGEVISALIST_C_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('CHNG_CHANGEVISALIST_U_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('CHNG_CHANGEVISALIST_U_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
EXCEPTION
   ...
   THEN
      ...
      RAISE;
END P_CHNG_CHANGEVISALIST_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHNG_CHANGEVISALIST_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CHNG_CHANGEVISALIST_M" TO "BIOSAADM";
