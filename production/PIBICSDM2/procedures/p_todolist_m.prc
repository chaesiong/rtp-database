CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TODOLIST_M" (v_dstart varchar2,v_dend varchar2)
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('TODOLIST_C_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('TODOLIST_C_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.TD_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('TODOLIST_U_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('TODOLIST_U_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_TODOLIST_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TODOLIST_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_TODOLIST_M" TO "BIOSAADM";
