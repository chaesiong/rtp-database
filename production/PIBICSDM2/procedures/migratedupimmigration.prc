CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."MIGRATEDUPIMMIGRATION" IS
tmpVar NUMBER;
/******************************************************************************
...
END migrateDupImmigration;
/
  GRANT EXECUTE ON "PIBICSDM2"."MIGRATEDUPIMMIGRATION" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."MIGRATEDUPIMMIGRATION" TO "BIOSAADM";
