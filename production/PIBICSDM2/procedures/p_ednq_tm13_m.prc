CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_EDNQ_TM13_M" (v_dstart varchar2,v_dend varchar2)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EDNQ_TM13_C_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EDNQ_TM13_C_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EDNQ_TM13_U_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EDNQ_TM13_U_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_EDNQ_TM13_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_EDNQ_TM13_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_EDNQ_TM13_M" TO "BIOSAADM";
