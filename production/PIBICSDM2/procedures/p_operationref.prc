CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_OPERATIONREF" 
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('OPERATIONREF_C', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('OPERATIONREF_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.OPER_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('OPERATIONREF_U', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('OPERATIONREF_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_OPERATIONREF;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_OPERATIONREF" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_OPERATIONREF" TO "BIOSAADM";
