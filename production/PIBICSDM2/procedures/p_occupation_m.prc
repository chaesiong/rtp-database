CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_OCCUPATION_M" (v_dstart varchar2,v_dend varchar2)
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('OCCUPATION_C_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('OCCUPATION_C_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.OCC_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('OCCUPATION_U_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('OCCUPATION_U_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_OCCUPATION_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_OCCUPATION_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_OCCUPATION_M" TO "BIOSAADM";
