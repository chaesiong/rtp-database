CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TMMAIN_OM" 
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('TMMAIN_OM_C', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL
 VALUES ('TMMAIN_OM_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.TMRUNNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('TMMAIN_OM_U', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL
 VALUES ('TMMAIN_OM_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_TMMAIN_OM;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TMMAIN_OM" TO "BIOSAADM";
