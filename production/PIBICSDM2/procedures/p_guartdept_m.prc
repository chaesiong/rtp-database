CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_GUARTDEPT_M" (v_dstart varchar,v_dend varchar)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('GUARTDEPT_C_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('GUARTDEPT_C_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('GUARTDEPT_U_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('GUARTDEPT_U_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_GUARTDEPT_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_GUARTDEPT_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_GUARTDEPT_M" TO "BIOSAADM";
