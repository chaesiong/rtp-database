CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_EXT_PERSON_M" (v_dstart varchar2,v_dend varchar2)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_PERSON_C_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_PERSON_C_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_PERSON_U_M', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_PERSON_U_M',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_EXT_PERSON_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_PERSON_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_PERSON_M" TO "BIOSAADM";
