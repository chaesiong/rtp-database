CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TMINOUT_RERUN_NOBLOB" (
    v_dstart VARCHAR2,/* Ex. 20181212 */
    v_dend VARCHAR2/* Ex. 20190115 */
 ...
 MERGE INTO PIBICSDM2.TMINOUT DM
  USING (SELECT 
     ...
     WHERE (CREDTE >= TO_DATE(v_dstart,'yyyymmdd')
              AND CREDTE < TO_DATE(v_dend,'yyyymmdd'))) P
  ON (DM.SEQNO = P.SEQNO)
 WHEN MATCHED 
 THEN 
...
INSERT INTO IMPORT_LOG_DETAIL VALUES ('TMINOUT_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_TMINOUT_RERUN_NOBLOB;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TMINOUT_RERUN_NOBLOB" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_TMINOUT_RERUN_NOBLOB" TO "BIOSAADM";
