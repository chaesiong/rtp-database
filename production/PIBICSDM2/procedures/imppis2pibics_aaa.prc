CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."IMPPIS2PIBICS_AAA" IS
BEGIN
      DECLARE
      --DECLARE TYPE           
      ...
      BATCHLOGNO_AAASEQ NUMBER :=0;
      FILETYPE_AAA VARCHAR2(8);
...
BEGIN     
  ...
  BEGIN
    SELECT PISFILE, FILE_TYPE INTO FILENAMEPISCES, FILETYPE_AAA FROM PISCESBATCHTMP WHERE TYPE = 'A';
    
    BATCHLOGNO_AAASEQ := BATCHLOG_SEQ.NEXTVAL;
    ...
    VALUES
    (BATCHLOGNO_AAASEQ, 'PISCES', FILETYPE_AAA, FILENAMEPISCES, NULL, 
    0, 0, 0, SYSDATE, NULL, 
            ...
            --START READ FROM FILE
                  ...
                  --READ LINE
                    ...
                    --SPLIT NAME
                              ...
                              --UTL_FILE.PUT_LINE(FLOG_HANDLER, 'START CHK DUPLICATE TMMAIN ' || TO_CHAR(SYSDATE, 'YYYY-MM-DD HH:MI:SS'));
                              PORT2PIBICS := NULL;
...
--                                          UTL_FILE.PUT_LINE(FLOG_HANDLER, '                    ---------------------------------------------');
            ...
            --UTL_FILE.PUT_LINE(FLOG_HANDLER, 'CHECK_ISERROR: ' || COUNTER_ERROR);
            IF  COUNTER_ERROR > 0 THEN
                ...
                WHERE BATCHLOGNO = BATCHLOGNO_AAASEQ;   
...
END IMPPIS2PIBICS_AAA;
/
  GRANT EXECUTE ON "PIBICSDM2"."IMPPIS2PIBICS_AAA" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."IMPPIS2PIBICS_AAA" TO "BIOSAADM";
