CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHK_BLACKLIST_T20190628" 
...
dbms_output.put_line('Thai :' || WLFULLNMTWO_T);
dbms_output.put_line('Thai :' || WLFULLNMTHREE_T);
...
END P_CHK_BLACKLIST_T20190628;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_T20190628" TO "BIOSAADM";
