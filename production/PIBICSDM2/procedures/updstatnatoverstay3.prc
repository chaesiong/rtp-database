CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDSTATNATOVERSTAY3" (S_YYYYMM IN VARCHAR2, E_YYYYMM IN VARCHAR2, P_YEAR IN NUMBER, P_START IN NUMBER, P_END IN NUMBER, P_SEX IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
    cursor c1 is
        ...
        from vw_immovs where to_char(processdte,'yyyymmdd') <= E_YYYYMM
        --from vw_immovs where to_char(inoutdte,'yyyymmdd') <= E_YYYYMM
        and lastdte < add_months(sysdte,- P_YEAR) and age >= P_START and age < P_END and sex = P_SEX
...
END UPDSTATNATOVERSTAY3;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATNATOVERSTAY3" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATNATOVERSTAY3" TO "BIOSAADM";
