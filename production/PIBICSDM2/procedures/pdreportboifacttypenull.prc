CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PDREPORTBOIFACTTYPENULL" (startDte in varchar2, endDte in varchar2, deptSeqno in Number, reasonSeqno in Number) IS
tmpVar NUMBER;
...
END PDreportboiFacttypeNull;
/
  GRANT EXECUTE ON "PIBICSDM2"."PDREPORTBOIFACTTYPENULL" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PDREPORTBOIFACTTYPENULL" TO "BIOSAADM";
