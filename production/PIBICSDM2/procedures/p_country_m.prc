CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_COUNTRY_M" (v_dstart varchar2,v_dend varchar2)
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('COUNTRY_C_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('COUNTRY_C_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.COUNT_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('COUNTRY_U_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('COUNTRY_U_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_COUNTRY_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_COUNTRY_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_COUNTRY_M" TO "BIOSAADM";
