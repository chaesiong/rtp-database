CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TM5" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG VALUES ('TM5_C', var_rows, SYSDATE);
   
   veddate :=sysdate;
   INSERT INTO IMPORT_LOG_DETAIL VALUES ('TM5_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
   ...
   INSERT INTO IMPORT_LOG VALUES ('TM5_U', var_rows, SYSDATE);
   
   veddate := sysdate;
   INSERT INTO IMPORT_LOG_DETAIL VALUES ('TM5_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_TM5;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TM5" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_TM5" TO "BIOSAADM";
