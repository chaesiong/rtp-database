CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."GEN_UNWATCHLIST0009" IS
tmpVar NUMBER;
/******************************************************************************
   NAME:       GEN_UNWATCHLIST0009
   PURPOSE:    

   REVISIONS:
   Ver        Date        Author           Description
   ---------  ----------  ---------------  ------------------------------------
   1.0        29/04/2014   Administrator       1. Created this procedure.

   NOTES:

   Automatically available Auto Replace Keywords:
      Object Name:     GEN_UNWATCHLIST0009
      Sysdate:         29/04/2014
      Date and Time:   29/04/2014, 15:12:16, and 29/04/2014 15:12:16
...
BEGIN
  DECLARE
    ...
    IS
      ...
      select * from watchlist where wlcd in ('S033621', 'S033622');
    ...
    WHEN c1%notfound;
      ...
      INTO watchlistlog
        ...
        (
          ...
          rec_tm.rmkarrest,
          rec_tm.rmkpermit,
          'ลบเนื่องจากสิ่งต้องปฏิบัติเป็น 0009',
          rec_tm.rmk11,
          rec_tm.rmk12,
          rec_tm.rmk13,
          rec_tm.rmkdte11,
...
END GEN_UNWATCHLIST0009;
/
  GRANT EXECUTE ON "PIBICSDM2"."GEN_UNWATCHLIST0009" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GEN_UNWATCHLIST0009" TO "BIOSAADM";
