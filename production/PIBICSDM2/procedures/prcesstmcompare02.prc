CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PRCESSTMCOMPARE02" IS
tmpVar NUMBER;
/******************************************************************************
   NAME:       TMCOMPARE01
   PURPOSE:    
...
file_ut UTL_FILE.FILE_TYPE;
    ...
    'ITTIPON'||inoutdte INDATE from vw_tmmain a, visatype b where a.visatypecd=B.VISATYPECD(+) and (to_char(inoutdate, 'yyyymmdd') between '20120425' and '20120430') 
...
begin
 ...
 loop
       ...
       insert into tmcompare02 (tmseq, tm6no, tdtno, efamilynm, efirstnm, emiddlenm, sex, birthdte, nationenm, cardtype, inoutdte, convregno,  depttnm, visa, age) 
...
END PRCESSTMCOMPARE02;
/
  GRANT EXECUTE ON "PIBICSDM2"."PRCESSTMCOMPARE02" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PRCESSTMCOMPARE02" TO "BIOSAADM";
