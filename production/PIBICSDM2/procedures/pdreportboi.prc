CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PDREPORTBOI" (startDte in varchar2, endDte in varchar2, deptSeqno in Number, reasonSeqno in Number) IS
tmpVar NUMBER;
...
END PDreportboi;
/
  GRANT EXECUTE ON "PIBICSDM2"."PDREPORTBOI" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PDREPORTBOI" TO "BIOSAADM";
