CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDNATSTATIMMCARD1" (P_YYYYMM IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
    ...
    and  to_number(to_char(inoutdte,'YYYYMMDDHH24MISS')) between '20130101000000' and to_number(to_char(sysdate,'YYYYMMDDHH24MISS'))
    --and to_number(to_char(inoutdte,'YYYYMMDDHH24MISS')) between '20130101000000' and '20150131235900'
    and cardtype = '1' 
    and a.count_seqno <> 200
    --and a.count_seqno = 218
...
END UPDNATSTATIMMCARD1;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDNATSTATIMMCARD1" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDNATSTATIMMCARD1" TO "BIOSAADM";
