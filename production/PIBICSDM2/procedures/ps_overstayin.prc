CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PS_OVERSTAYIN" IS
tmpVar NUMBER;
/******************************************************************************
   NAME:       PS_OVERSTAYOUT
   PURPOSE:    
...
BEGIN
  DECLARE
    ...
    select cardtype, tm6no, efamilynm, efirstnm, emiddlenm, tdtno, nationcd, birthdte, inoutdte maxinoutdte ,personid
    from immigration 
    where to_char(inoutdte, 'YYYYMMDD') = to_char(sysdate -1, 'YYYYMMDD')
    --where to_char(inoutdte, 'YYYYMMDD') between '20180202' and '20180206' 
  ...
  --select * from immigration where to_char(upddte, 'YYYYMMDD') = '20150307' and tdtno='N1849377' and cardtype = '2' and (nationcd <> 'T03' and visatype_seqno <> '9');
    ...
    BEGIN
        ...
        values (batchlogno_seq, 'OVS', '18', 'OVERSTAY IN ' || to_char(sysdate -1, 'dd/MM/yyyy'), null, 0, 0, 0, sysdate, null, '1', 'OVS001', sysdate, 'N', 0, 0, 0, sysdate);
        commit;
        
--        file_ut := UTL_FILE.FOPEN('LOGS_DIR', 'log_PS_OVERSTAYIN' || sysdateFile || '.txt', 'W');
--        utl_file.put_line(file_ut, sysdateTxt || ' Start PS_OVERSTAYIN .... !!!');
--        utl_file.fflush(file_ut);
        ...
        LOOP FETCH c1 INTO rec_imm; EXIT WHEN c1%NOTFOUND;
            ...
            FOR rec_tm IN (select * from processfines where personid = rec_imm.personid 
            ...
            LOOP
                ...
                rec_tm.rqsperson_seqno, rec_tm.rqspermitdte, rec_tm.rqsflag, rec_tm.fnperson_seqno, rec_tm.alien_seqno, rec_tm.processdte, sysdate, 'OVERSTAY_IN Personid = ' || rec_tm.personid, 
            ...
            IF postfix IS NULL THEN
                ...
                LOOP
                    ...
                    rec_tm.create_date, rec_tm.update_by, rec_tm.update_date, rec_tm.version, rec_tm.conv_seqno, rec_tm.visatype_seqno, rec_tm.dept_seqno, rec_tm.count_seqno, rec_tm.permit_seqno,
                    rec_tm.flightprefix, rec_tm.flightnumber, rec_tm.deptcd, rec_tm.extperson_seqno, rec_tm.extpermitdte, rec_tm.extflag, rec_tm.chngperson_seqno, rec_tm.chngpermitdte, rec_tm.chngflag, 
                    rec_tm.rqsperson_seqno, rec_tm.rqspermitdte, rec_tm.rqsflag, rec_tm.fnperson_seqno, rec_tm.alien_seqno, rec_tm.processdte, sysdate, 'OVERSTAY_IN tdtno nationcd = ' || rec_tm.personid, 
                    rec_tm.ovsdte, rec_tm.yearofdob, rec_tm.sexdesc, rec_tm.deptlevel1, rec_tm.deptlevel2, rec_tm.building, rec_tm.addr, rec_tm.road, rec_tm.pv_seqno, rec_tm.amp_seqno, 
                    rec_tm.tmb_seqno, rec_tm.tel, rec_tm.typeaddr, rec_tm.lastpermitdte);                  
            ...
            IF postfix IS NULL THEN
                IF rec_imm.efamilynm is not null and rec_imm.efirstnm is not null and rec_imm.emiddlenm is null THEN 
                    ...
                    LOOP
                        ...
                        rec_tm.create_date, rec_tm.update_by, rec_tm.update_date, rec_tm.version, rec_tm.conv_seqno, rec_tm.visatype_seqno, rec_tm.dept_seqno, rec_tm.count_seqno, rec_tm.permit_seqno,
                        rec_tm.flightprefix, rec_tm.flightnumber, rec_tm.deptcd, rec_tm.extperson_seqno, rec_tm.extpermitdte, rec_tm.extflag, rec_tm.chngperson_seqno, rec_tm.chngpermitdte, rec_tm.chngflag, 
                        rec_tm.rqsperson_seqno, rec_tm.rqspermitdte, rec_tm.rqsflag, rec_tm.fnperson_seqno, rec_tm.alien_seqno, rec_tm.processdte, sysdate, 'OVERSTAY_IN 2in3 name birthdte = ' || rec_tm.personid, 
                        rec_tm.ovsdte, rec_tm.yearofdob, rec_tm.sexdesc, rec_tm.deptlevel1, rec_tm.deptlevel2, rec_tm.building, rec_tm.addr, rec_tm.road, rec_tm.pv_seqno, rec_tm.amp_seqno, 
                        rec_tm.tmb_seqno, rec_tm.tel, rec_tm.typeaddr, rec_tm.lastpermitdte); 
...
--        utl_file.fflush(file_ut);
--        utl_file.put_line(file_ut, sysdateTxt || ' End PS_OVERSTAYIN .... !!!');
--        utl_file.fflush(file_ut);
...
END PS_OVERSTAYIN;
/
  GRANT EXECUTE ON "PIBICSDM2"."PS_OVERSTAYIN" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PS_OVERSTAYIN" TO "BIOSAADM";
