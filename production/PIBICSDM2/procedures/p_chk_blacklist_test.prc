CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHK_BLACKLIST_TEST" 
...
END P_CHK_BLACKLIST_TEST;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST" TO "BIOSAADM";
