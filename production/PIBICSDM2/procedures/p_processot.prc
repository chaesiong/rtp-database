CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_PROCESSOT" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('PROCESSOT_U', var_rows, SYSDATE);
...
END P_PROCESSOT;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_PROCESSOT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_PROCESSOT" TO "BIOSAADM";
