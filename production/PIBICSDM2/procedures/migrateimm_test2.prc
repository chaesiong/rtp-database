CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."MIGRATEIMM_TEST2" IS
tmpVar NUMBER;
tdtnoOld varchar(10);
tdtnoNew varchar(10);
BEGIN
...
tdtnoNew := 'AA3270522';
declare
    cursor c_passtmp is select * from (select tdtnoOld TDTNO,'' FLAG,'' STATUS,'' UPDATE_DELETE from dual);--TESTPASSTEMP WHERE STATUS IS NULL;
...
END MIGRATEIMM_TEST2;
/
  GRANT EXECUTE ON "PIBICSDM2"."MIGRATEIMM_TEST2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."MIGRATEIMM_TEST2" TO "BIOSAADM";
