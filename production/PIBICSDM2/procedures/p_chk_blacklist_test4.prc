CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHK_BLACKLIST_TEST4" 
(
...
BEGIN
    ...
    IF V_Results <> 'NotFound' THEN
        BEGIN
            ...
            VALUES (P_WLCD, P_MOVEMENTID, SYSDATE);
...
END P_CHK_BLACKLIST_TEST4;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST4" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CHK_BLACKLIST_TEST4" TO "BIOSAADM";
