CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TM2" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG VALUES ('TM2_C', var_rows, SYSDATE);
   
   veddate :=sysdate;
   INSERT INTO IMPORT_LOG_DETAIL VALUES ('TM2_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
   ...
   INSERT INTO IMPORT_LOG VALUES ('TM2_U', var_rows, SYSDATE);
   
   veddate :=sysdate;
   INSERT INTO IMPORT_LOG_DETAIL VALUES ('TM2_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_TM2;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TM2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_TM2" TO "BIOSAADM";
