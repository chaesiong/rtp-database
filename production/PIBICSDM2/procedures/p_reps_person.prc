CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_REPS_PERSON" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('REPS_PERSON_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('REPS_PERSON_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('REPS_PERSON_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('REPS_PERSON_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_REPS_PERSON;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_REPS_PERSON" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_REPS_PERSON" TO "BIOSAADM";
