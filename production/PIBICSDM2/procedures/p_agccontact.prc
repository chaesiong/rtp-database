CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_AGCCONTACT" 
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('AGCCONTACT_C', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('AGCCONTACT_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.AGCCONT_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('AGCCONTACT_U', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('AGCCONTACT_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_AGCCONTACT;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_AGCCONTACT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_AGCCONTACT" TO "BIOSAADM";
