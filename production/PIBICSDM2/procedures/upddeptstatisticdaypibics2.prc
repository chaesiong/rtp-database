CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDDEPTSTATISTICDAYPIBICS2" (S_DATE IN VARCHAR2, STATISTICFILED  IN VARCHAR2, TYPECARD in varchar2) IS
tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
   ...
   with departmentlevel as (
    ...
    where to_char(inoutdate, 'yyyymmdd') = S_DATE  
...
END UPDDEPTSTATISTICDAYPIBICS2;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATISTICDAYPIBICS2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATISTICDAYPIBICS2" TO "BIOSAADM";
