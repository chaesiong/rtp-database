CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDSTATNATOVERSTAY1" (S_YYYYMM IN VARCHAR2, E_YYYYMM IN VARCHAR2, P_YEAR IN NUMBER, P_START IN NUMBER, P_END IN NUMBER, P_SEX IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
END UPDSTATNATOVERSTAY1;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATNATOVERSTAY1" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATNATOVERSTAY1" TO "BIOSAADM";
