CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."GENDEPT2LEVEL" IS
tmpVar NUMBER;
/******************************************************************************
   NAME:       GENDEPT2LEVEL
   PURPOSE:    
...
declare
    ...
    cursor c1 is
    select * from department where dept_seqno = 382;
    dept c1%rowtype;  
begin 
 open c1;
...
END GENDEPT2LEVEL;
/
  GRANT EXECUTE ON "PIBICSDM2"."GENDEPT2LEVEL" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GENDEPT2LEVEL" TO "BIOSAADM";
