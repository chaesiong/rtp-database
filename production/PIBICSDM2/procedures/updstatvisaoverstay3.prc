CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDSTATVISAOVERSTAY3" (P_YYYYMM IN VARCHAR2, P_YEAR IN NUMBER, P_START IN NUMBER, P_END IN NUMBER, P_SEX IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
    cursor c1 is
        ...
        --from vw_immovs where to_char(inoutdte,'yyyymmdd')<= P_YYYYMM
...
END UPDSTATVISAOVERSTAY3;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATVISAOVERSTAY3" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATVISAOVERSTAY3" TO "BIOSAADM";
