CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHNG_CHANGEVISA" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('CHNG_CHANGEVISA_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('CHNG_CHANGEVISA_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('CHNG_CHANGEVISA_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('CHNG_CHANGEVISA_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
EXCEPTION
   ...
   THEN
      ...
      RAISE;
END P_CHNG_CHANGEVISA;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CHNG_CHANGEVISA" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CHNG_CHANGEVISA" TO "BIOSAADM";
