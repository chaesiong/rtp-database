CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CREW" 
IS
...
BEGIN
 ...
 vstdate :=sysdate;
   ...
   INSERT INTO IMPORT_LOG VALUES ('CREW_C', var_rows, SYSDATE);

  veddate :=sysdate;
   
  INSERT INTO IMPORT_LOG_DETAIL VALUES ('CREW_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
 ...
 vstdate :=sysdate;
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('CREW_U', var_rows, SYSDATE);

  veddate :=sysdate;
   
  INSERT INTO IMPORT_LOG_DETAIL VALUES ('CREW_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
END P_CREW;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_CREW" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_CREW" TO "BIOSAADM";
