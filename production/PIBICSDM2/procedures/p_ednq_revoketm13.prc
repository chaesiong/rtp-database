CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_EDNQ_REVOKETM13" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EDNQ_REVOKETM13_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EDNQ_REVOKETM13_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EDNQ_REVOKETM13_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EDNQ_REVOKETM13_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
EXCEPTION
   ...
   THEN
      ...
      RAISE;
END P_EDNQ_REVOKETM13;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_EDNQ_REVOKETM13" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_EDNQ_REVOKETM13" TO "BIOSAADM";
