CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_REASON" 
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('REASON_C', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('REASON_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
VALUES (     P.REASON_SEQNO,
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('REASON_U', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('REASON_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
