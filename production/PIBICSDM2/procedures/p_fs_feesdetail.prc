CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_FS_FEESDETAIL" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FS_FEESDETAIL_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FS_FEESDETAIL_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FS_FEESDETAIL_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FS_FEESDETAIL_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_FS_FEESDETAIL;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_FS_FEESDETAIL" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_FS_FEESDETAIL" TO "BIOSAADM";
