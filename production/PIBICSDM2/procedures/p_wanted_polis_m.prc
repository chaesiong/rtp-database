CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_WANTED_POLIS_M" (v_dstart varchar2,v_dend varchar2)
IS
...
BEGIN
 ...
 INSERT INTO IMPORT_LOG
  VALUES ('WANTED_POLIS_C_M', var_rows, SYSDATE);
 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL 
 VALUES ('WANTED_POLIS_C_M', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
...
EXCEPTION
 ...
 -- Consider logging the error and then re-raise
  RAISE;
END P_WANTED_POLIS_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_WANTED_POLIS_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_WANTED_POLIS_M" TO "BIOSAADM";
