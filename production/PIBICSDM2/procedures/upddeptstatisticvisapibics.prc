CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDDEPTSTATISTICVISAPIBICS" (P_YYYYMM IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
--tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
    ...
    --INOUT
    select visatypecd, count(visatypecd) amount
    from vw_tmmain  
...
begin
 ...
 loop fetch c1 into recs; exit when c1%notfound;
        ...
        SQLCOMMAND:='UPDATE STATISTICVISAPIBICS SET '||STATISTICFILED||' = '||AMOUNT||' WHERE VISATYPECD = '''||recs.visatypecd||'''';
...
END UPDDEPTSTATISTICVISAPIBICS;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATISTICVISAPIBICS" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATISTICVISAPIBICS" TO "BIOSAADM";
