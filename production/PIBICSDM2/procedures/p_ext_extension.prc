CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_EXT_EXTENSION" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_EXTENSION_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_EXTENSION_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('EXT_EXTENSION_U', var_rows, SYSDATE);


   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('EXT_EXTENSION_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_EXT_EXTENSION;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_EXTENSION" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_EXT_EXTENSION" TO "BIOSAADM";
