CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_TMINFORMDEAD" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('TMINFORMDEAD_C', var_rows, SYSDATE);

 veddate :=sysdate;
 INSERT INTO IMPORT_LOG_DETAIL VALUES ('TMINFORMDEAD_C', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
 COMMIT;
 ...
 vstdate :=sysdate;
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('TMINFORMDEAD_U', var_rows, SYSDATE);

  veddate :=sysdate;
  INSERT INTO IMPORT_LOG_DETAIL VALUES ('TMINFORMDEAD_U', var_rows,SYSDATE,v_dstart,v_dend,vstdate,veddate);
  COMMIT;
...
END P_TMINFORMDEAD;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_TMINFORMDEAD" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_TMINFORMDEAD" TO "BIOSAADM";
