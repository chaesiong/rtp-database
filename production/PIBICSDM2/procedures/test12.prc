CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."TEST12" (startDte in varchar2, endDte in varchar2, deptSeqno in Number, reasonSeqno in Number, facttypeStr in varchar2) IS
tmpVar NUMBER;
...
END test12;
/
  GRANT EXECUTE ON "PIBICSDM2"."TEST12" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."TEST12" TO "BIOSAADM";
