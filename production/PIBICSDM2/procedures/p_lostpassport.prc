CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_LOSTPASSPORT" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('LOSTPASSPORT_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('LOSTPASSPORT_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('LOSTPASSPORT_U', var_rows, SYSDATE);


   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('LOSTPASSPORT_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_LOSTPASSPORT;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_LOSTPASSPORT" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_LOSTPASSPORT" TO "BIOSAADM";
