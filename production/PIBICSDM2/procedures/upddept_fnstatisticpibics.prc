CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDDEPT_FNSTATISTICPIBICS" (P_YYYYMM IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
BEGIN
declare
...
file_ut UTL_FILE.FILE_TYPE;
   ...
   with departmentlevel as (
    ...
    --and VISATYPE_SEQNO = 2
    --and to_char(a.CHECKINDTE, 'YYYYMM') = P_YYYYMM and VISATYPE_SEQNO not in(2,10)
...
END UPDDEPT_FNSTATISTICPIBICS;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPT_FNSTATISTICPIBICS" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPT_FNSTATISTICPIBICS" TO "BIOSAADM";
