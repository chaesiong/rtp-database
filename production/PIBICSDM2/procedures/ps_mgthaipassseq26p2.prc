CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PS_MGTHAIPASSSEQ26P2" is
tmpvar number;
/******************************************************************************
...
begin
  declare
    ...
    cursor c1 is    
        select * from thaipassport where pps_seqno = 2 and pass_seqno <> '6' and tmppass_seqno is null and to_char(update_date, 'yyyymmdd') = to_char(sysdate, 'yyyymmdd');
    rec_thp c1%rowtype;
    ...
    begin
        ...
        values (batchlogno_seq, 'PPS', '44', 'MIGRATE THP2and6P2', null, 0, 0, 0, sysdate, null, '1', 'PPS001', sysdate, 'N', 0, 0, 0, sysdate);
        commit;
...
end ps_mgthaipassseq26P2;
/
  GRANT EXECUTE ON "PIBICSDM2"."PS_MGTHAIPASSSEQ26P2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PS_MGTHAIPASSSEQ26P2" TO "BIOSAADM";
