CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."GEN_WANTED_POLIS_RELEASE_Y" 
IS
  tmpVar NUMBER;
  /******************************************************************************
    ...
    WHEN c1%notfound;
      ...
      INTO watchlistlog
        ...
        (
          ...
          rec_tm.rmkarrest,
          rec_tm.rmkpermit,
          'เป็นหมายจับที่ฝั่ง POLIS ดำเนินการลบ ',
          rec_tm.rmk11,
          rec_tm.rmk12,
          rec_tm.rmk13,
          rec_tm.rmkdte11,
...
END;
/
  GRANT EXECUTE ON "PIBICSDM2"."GEN_WANTED_POLIS_RELEASE_Y" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GEN_WANTED_POLIS_RELEASE_Y" TO "BIOSAADM";
