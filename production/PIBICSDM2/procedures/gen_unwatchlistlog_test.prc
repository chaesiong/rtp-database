CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."GEN_UNWATCHLISTLOG_TEST" 
IS
  tmpVar NUMBER;
BEGIN
  DECLARE
    ...
    CURSOR z1
    IS
        select * from watchlist a, watchlistnm b, wlindicatecard c where a.wlcd=b.wlcd and a.wlcd=c.wlcd and c.docno is not null and a.nationcd ='T03' and b.seqno='0' and length(c.docno) = 13 and a.birthdte is null  and flagcheckpoint='Y' ;
    rec_tm z1%rowtype;
  BEGIN
    ...
    WHEN z1%notfound;
      ...
      LOOP
        INSERT
        INTO PIBICSDEV.WLINDICATECARDLOG
          (
            WLCD,
            SEQNO,
            IDCCD,
...
END;
/
  GRANT EXECUTE ON "PIBICSDM2"."GEN_UNWATCHLISTLOG_TEST" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GEN_UNWATCHLISTLOG_TEST" TO "BIOSAADM";
