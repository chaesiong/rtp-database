CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_FLIGHTNUMBERS" 
IS
...
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FLIGHTNUMBERS_C', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FLIGHTNUMBERS_C',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('FLIGHTNUMBERS_U', var_rows, SYSDATE);

   veddate := SYSDATE;

   INSERT INTO IMPORT_LOG_DETAIL
        VALUES ('FLIGHTNUMBERS_U',
                var_rows,
                SYSDATE,
                v_dstart,
                v_dend,
...
END P_FLIGHTNUMBERS;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_FLIGHTNUMBERS" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_FLIGHTNUMBERS" TO "BIOSAADM";
