CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_RQS_TM9_M" (v_dstart varchar2,v_dend varchar2)
IS
   var_rows   NUMBER;
   vstdate    DATE;
   veddate    DATE;
BEGIN
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('RQS_TM9_C_M', var_rows, SYSDATE);
   ...
   INSERT INTO IMPORT_LOG
        VALUES ('RQS_TM9_U_M', var_rows, SYSDATE);
...
END P_RQS_TM9_M;
/
  GRANT EXECUTE ON "PIBICSDM2"."P_RQS_TM9_M" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."P_RQS_TM9_M" TO "BIOSAADM";
