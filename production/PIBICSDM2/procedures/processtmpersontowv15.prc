CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."PROCESSTMPERSONTOWV15" IS
tmpVar NUMBER;
BEGIN
declare
...
file_ut UTL_FILE.FILE_TYPE;
    ...
    and invisatypecd = '0013'  and intdtno <> 'PASSPORT' and nationcd not in ('I02', 'U07', 'E05', 'U06', 'R03', 'B20', 'M16', 'T01', 'C10', 'B15', 'K06')
...
begin
    ...
    values ( batchlogno_seq, 'PIBICS', '999', 'PROCESSTMPERSONTOWV15', null, 0, 0, 0, sysdate, null, '1', 'ADMIN01', sysdate, 'N');     
    commit;  
 
    delete tmpersontowv15;
    commit;

    file_ut := UTL_FILE.FOPEN('LOGS_DIR','log_PROCESSTMPERSONTOWV15'||sysdateFile||'.txt','W');
    utl_file.put_line(file_ut,sysdateTxt||' Start PROCESSTMPERSONTOWV15 .... !!!');utl_file.fflush(file_ut); 
    open c1;
    ...
    <<itemtm_loop>> for itm in
     ...
     loop
        ...
        --addressfn := get_addrfn24(rec_tm.intdtno, rec_tm.nationcd);
         ...
         insert into tmpersontowv15 (tmseqno, efamilynm, efirstnm, emiddlenm, sex, birthdte, nationcd, passportno, amount, inoutdte, dept_seqno, tm6no, chkcapture, fn38, cardtype) 
        values 
 ...
 select to_char(sysdate,'dd/mm/yyyy hh24:mi:ss') into sysdateTxt from dual;
 utl_file.put_line(file_ut,sysdateTxt||' End PROCESSTMPERSONTOWV15 .... !!!');utl_file.fflush(file_ut);
...
END PROCESSTMPERSONTOWV15;
/
  GRANT EXECUTE ON "PIBICSDM2"."PROCESSTMPERSONTOWV15" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."PROCESSTMPERSONTOWV15" TO "BIOSAADM";
