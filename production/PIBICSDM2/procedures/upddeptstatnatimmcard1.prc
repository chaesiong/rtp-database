CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDDEPTSTATNATIMMCARD1" (P_YYYYMM IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
file_ut UTL_FILE.FILE_TYPE;
    ...
    select a.count_seqno, count('X') amount
    from immigration a, visatype b 
    where  a.visatype_seqno = b.visatype_seqno and  to_number(to_char(inoutdte,'YYYYMMDDHH24MISS')) between '20130101000000' and to_number(to_char(sysdate,'YYYYMMDDHH24MISS'))
    and cardtype = '1' 
    and a.visatype_seqno is not null 
    and a.visatype_seqno not in (10, 9, 19)
    group by a.count_seqno;
...
END UPDDEPTSTATNATIMMCARD1;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATNATIMMCARD1" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDDEPTSTATNATIMMCARD1" TO "BIOSAADM";
