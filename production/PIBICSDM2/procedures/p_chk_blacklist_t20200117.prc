CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."P_CHK_BLACKLIST_T20200117" 
(
    ...
    --V_Results           DL_BLACKLIST.TT_VARCHAR2 := DL_BLACKLIST.TT_VARCHAR2();
      V_Results        VARCHAR2(100) := 'NotFound';        --Tong
    --
    ...
    --
    l_bl_demo_search_source NUMBER := TO_NUMBER(NVL(dl_bordercontrol.pkg_common.Get_Parameter('BL_DEMO_SEARCH_SRC'), 0));  --0
    l_bl_demo_search_type   NUMBER := TO_NUMBER(NVL(dl_bordercontrol.pkg_common.Get_Parameter('BL_DEMO_SEARCH_TYPE'), 0));   --0
