CREATE OR REPLACE EDITIONABLE PROCEDURE "PIBICSDM2"."UPDSTATVISAOVERSTAY2" (P_YYYYMM IN VARCHAR2, P_YEAR1 IN NUMBER, P_YEAR2 IN NUMBER, P_START IN NUMBER, P_END IN NUMBER, P_SEX IN VARCHAR2, STATISTICFILED  IN VARCHAR2) IS
tmpVar NUMBER;
/******************************************************************************
...
END UPDSTATVISAOVERSTAY2;
/
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATVISAOVERSTAY2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."UPDSTATVISAOVERSTAY2" TO "BIOSAADM";
