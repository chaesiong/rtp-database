CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."PRT_INOUT1" ("INOUTDATE", "MVMNTID", "BRDDOCID", "EXITFLG", "DOCNO", "GIVENNAME", "SURNAME", "SEX", "NAT", "NAME", "IPADDRESS", "SECONDS", "CONTINENT", "PERSON_TYPE", "VISATYPE") AS 
  SELECT TO_CHAR (Date_of_entry, 'DD-MON-YYYY') AS INOUTDATE,
   ...
   /*                         AND d.DOCNO IN (SELECT DOCNO
            ...
            WHERE aa.row_num = 1)
    WHERE diff_second > 5 AND diff_second < 90 WITH CHECK OPTION;
  GRANT DELETE ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."PRT_INOUT1" TO "BIOSAADM";
