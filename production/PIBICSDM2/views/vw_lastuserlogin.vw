CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VW_LASTUSERLOGIN" ("DEPT_SEQNO", "DEPARTNAME", "USER_ID", "USERNAME", "IPADDRESS", "PROGRAM_ID", "PROGRAM_NAME", "SYSTEM_NAME", "APPSERV", "LOGINDATE") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_LASTUSERLOGIN" TO "BIOSAADM";
