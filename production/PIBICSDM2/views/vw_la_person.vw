CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VW_LA_PERSON" ("PERSON_SEQNO", "FLAG_SEQNO", "SUFFIX_SEQNO", "EFIRSTNM", "EFAMILYNM", "EMIDDLENM", "BIRTHDATE", "NATION_SEQNO", "SEX", "OCC_SEQNO", "TL38", "IMGPERSON", "TM6NO", "ARRIVED_BY", "ARRIVED_DATE", "ARRIVED_DEPT", "IMGPASS", "PASSPORTNO", "PASSPORT_ISSUEAT", "PASSPORT_ISSUEDATE", "PASSPORT_EXPDATE", "VISANO", "VISA_SEQNO", "VISA_DATE", "VISA_EXPDATE", "CREATE_BY", "APPLY_DATE", "CDEPT_SEQNO", "CZONE_SEQNO") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_LA_PERSON" TO "BIOSAADM";
