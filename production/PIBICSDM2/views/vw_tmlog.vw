CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VW_TMLOG" ("LOGTMINOUTID", "LOGUSERID", "LOGFLAG", "LOGDTE", "CARDTYPE", "TMRUNNO", "PERSONID", "IMGINOUT", "EFULLNAME", "SEX", "NATIONCD", "NATIONENM", "BIRTHDTE", "DEPTCD", "DEPTTNM", "EFIRSTNM", "EFAMILYNM", "EMIDDLENM", "TFIRSTNM", "TMIDDLENM", "TFAMILYNM", "TFSNDXNM", "TMSNDXNM", "TLSNDXNM", "EFSNDXNM", "ELSNDXNM", "EMSNDXNM", "TDTNO", "TM6NO", "SEQNO", "CONVREGNO", "CONVCD", "INOUTDTE", "TRAVCD", "VISATYPE_SEQNO", "VISATYPECD", "VISATYPETNM", "VISAEXPDTE", "FLAGMATCH", "FLAGDEAD", "INOUTDATE", "DEPT_SEQNO", "FLIGHTPREFIX", "FLIGHTNUMBER", "REMARK", "TDTCD", "TYPEDATA", "PERMITCD", "PERMITDTE", "PERMIT_SEQNO", "TMINOUTDTE", "PASSPORTDTE", "PASSPORTEXPDTE", "CREUSR", "CREDTE", "CREDTERM", "UPDUSR", "UPDDTE", "UPDTERM", "RESCERTNO", "FLAGJOINPASS", "DEPTL2TNM", "COUNT_SEQNO", "CONV_SEQNO", "TYPEENQ", "CHKPOINTNO", "INTYPE", "CITIZENID", "MATCHTM6", "PV_SEQNO", "PD_SEQNO", "ZONE_SEQNO", "SHIFT_SEQNO", "PASSPORTISU") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_TMLOG" TO "BIOSAADM";
