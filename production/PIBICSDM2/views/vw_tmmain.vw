  ...
  SELECT '1' cardtype,
   ...
   SELECT cardtype,
          ...
          DECODE (flagfines,
             ...
             flagfines
     FROM tminout_ma;
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_TMMAIN" TO "BIOSAADM";
