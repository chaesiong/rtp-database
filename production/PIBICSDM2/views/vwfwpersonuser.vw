CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VWFWPERSONUSER" ("PERSON_GEN", "PERSON_NAME", "PERSON_ID", "POSLEVEL_GEN", "BIRTHDATE", "STATUS_TM", "ORG_GEN", "ORG_CODE", "ORG_NAME") AS 
  SELECT HR_PROFILE.PROFILE_SEQNO PERSON_GEN,
            ...
            HR_PROFILE.STATUS_TM,
            DEPARTMENT.DEPT_SEQNO ORG_GEN,
            DEPARTMENT.DEPTCD ORG_CODE,
            DECODE (GET_DEPTABBRNM3LEVEL (DEPARTMENT.DEPT_SEQNO, ' '),
                    NULL, PIBICS.get_DeptName (DEPARTMENT.DEPT_SEQNO, 'T'),
                    GET_DEPTABBRNM3LEVEL (DEPARTMENT.DEPT_SEQNO, ' '))
               ORG_NAME
       FROM    HR_PROFILE
            LEFT JOIN
               DEPARTMENT
