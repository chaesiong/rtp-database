CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VWCRS_EDNQ" ("EDNQPERSON_SEQNO", "NATIONCD", "CPASSPORTNO", "CPASSPORTEXP_DATE", "EFAMILYNM", "EFIRSTNM", "EMIDDLENM", "TFAMILYNM", "RCNO_RUNNINGNO", "RCNO_YEAR", "TFIRSTNM", "TMIDDLENM", "BIRTH_DATE", "SEX", "CERTOFRESIDENCE_SEQNO", "PERMIT_DATE", "RESCERTTYPE", "RCNO_PVCD", "RESCERTNO", "FLAGPERMIT", "RESCERTTYPE_SEQNO", "DEPTISSUEDRCNAME", "NATIONENM", "PERMIT_SEQNO", "TM13NO", "TM13STS", "TM22STS", "TM22TYPE", "FLAGUPDATEEDNQ", "STATUSEDNQ", "TM22_SEQNO", "ISSUE_DATE") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VWCRS_EDNQ" TO "BIOSAADM";
