CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VW_IMMOVS" ("IOVSEQNO", "PERSONID", "TM6NO", "INOUTDTE", "CARDTYPE", "TFIRSTNM", "TMIDDLENM", "TFAMILYNM", "EFIRSTNM", "EMIDDLENM", "EFAMILYNM", "SEX", "BIRTHDTE", "NATIONCD", "TDTCD", "TDTNO", "VISATYPECD", "VISAEXPDTE", "PASSPORTDTE", "PASSPORTEXPDTE", "UPDUSR", "UPDDTE", "UPDTERM", "REMARK", "STATUS", "TM5_SEQNO", "TM2INOUT_SEQNO", "CONVCD", "CONVREGNO", "SEQNO", "CREATE_BY", "CREATE_DATE", "UPDATE_BY", "UPDATE_DATE", "VERSION", "CONV_SEQNO", "VISATYPE_SEQNO", "DEPT_SEQNO", "COUNT_SEQNO", "PERMIT_SEQNO", "FLIGHTPREFIX", "FLIGHTNUMBER", "DEPTCD", "EXTPERSON_SEQNO", "EXTPERMITDTE", "EXTFLAG", "CHNGPERSON_SEQNO", "CHNGPERMITDTE", "CHNGFLAG", "RQSPERSON_SEQNO", "RQSPERMITDTE", "RQSFLAG", "FNPERSON_SEQNO", "ALIEN_SEQNO", "PROCESSDTE", "AGE", "SYSDTE", "LASTDTE") AS 
  SELECT a."IOVSEQNO",
    ...
    WHERE a.nationcd IS NOT NULL
          ...
          --AND count_seqno = 96;;
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_IMMOVS" TO "BIOSAADM";
