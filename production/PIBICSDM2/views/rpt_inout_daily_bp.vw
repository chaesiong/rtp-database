...
;
  GRANT DELETE ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."RPT_INOUT_DAILY_BP" TO "BIOSAADM";
