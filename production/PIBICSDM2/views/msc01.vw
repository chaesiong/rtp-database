...
OUTSHIFT_SEQNO
from tmmain;
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."MSC01" TO "BIOSAADM";
