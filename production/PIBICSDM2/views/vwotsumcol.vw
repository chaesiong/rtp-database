CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VWOTSUMCOL" ("ESTIMATEYEAR", "ESTIMATEMONTH", "OTMONEY", "ZEROTWOPER", "ZEROEIGHTPER", "TWOPER", "TOCTWOPER", "POLICEDEATH", "CREMATION", "TAXRATE", "WATER", "DEPTSEQNO") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VWOTSUMCOL" TO "BIOSAADM";
