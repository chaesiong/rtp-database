...
SELECT cardtype,
   ...
   SELECT '1' cardtype,
          ...
          0 shift_seqno,
            ...
            instatus status, 
            intm5_seqno tm5_seqno, 
            intm2inout_seqno tm2inout_seqno
     FROM tmmain
   ...
   SELECT '2' cardtype,
          ...
          0 shift_seqno,
                    ...
                    outstatus status, 
                    outtm5_seqno tm5_seqno, 
                    outtm2inout_seqno tm2inout_seqno
     FROM tmmain
    WHERE outdte IS NOT NULL;
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_TMONLINE" TO "BIOSAADM";
