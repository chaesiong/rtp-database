CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."V_RPT_INOUT" ("INOUTDATE", "MVMNTID", "BRDDOCID", "EXITFLG", "DOCNO", "GIVENNAME", "SURNAME", "SEX", "NAT", "NAME", "IPADDRESS", "SECONDS", "CONTINENT", "PERSON_TYPE", "VISATYPE") AS 
  ...
  GRANT DELETE ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."V_RPT_INOUT" TO "BIOSAADM";
