CREATE OR REPLACE FORCE EDITIONABLE VIEW "PIBICSDM2"."VW_WLONLINE" ("WLCD", "SEQNO", "WLTFIRSTNM", "WLTLASTNM", "WLTMIDDLENM", "SEX", "WLELASTNM", "WLEFIRSTNM", "WLEMIDDLENM", "BIRTHPLACE", "BIRTHDTE", "BIRTHDATE", "ORGNM", "AGCCONTCD", "AGCCONTNM", "AGCPHONE", "DOCREF", "PRECINCTTNM", "OPERREFNM", "BLAWSNO", "RLAWSNO", "PENALNO", "DOCREFER", "RMKAGCCONT", "EMGCONT", "SECRETNM", "WARRNO", "RMKARREST", "NATIONTNM", "WARRDTE", "WARREXPDTE", "TDTNM", "REASONTNM", "CUSERNM", "CREDTE", "REASONCD", "KEYDATE", "NATIONCD", "DEPT_SEQNO", "SEXCODE", "OTHERAGCCONT", "CREATE_DATE") AS 
  ...
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "ROLE_PIBICSAPP";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "BIO_BD";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "APPSUP";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "BIOAPPREPORT";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSUPPORT";
  GRANT DELETE ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT INSERT ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT SELECT ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT UPDATE ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT REFERENCES ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT READ ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT DEBUG ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT FLASHBACK ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
  GRANT MERGE VIEW ON "PIBICSDM2"."VW_WLONLINE" TO "BIOSAADM";
