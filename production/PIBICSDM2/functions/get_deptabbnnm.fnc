CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTABBNNM" (deptseqno_tmp Number, flag varchar2) return varchar2 is
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTABBNNM" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTABBNNM" TO "BIOSAADM";
