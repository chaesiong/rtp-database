CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTNAMEABBLEVEL2" (deptseqno_tmp Number, flag varchar2) return varchar2 is
enm varchar2(200);
tnm varchar2(200);
tmp varchar2(200);
tmplevel Number(1);
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNAMEABBLEVEL2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNAMEABBLEVEL2" TO "BIOSAADM";
