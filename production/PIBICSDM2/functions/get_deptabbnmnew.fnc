CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTABBNMNEW" (deptseqno_tmp Number, flag varchar2) return varchar2 is
...
begin
 ...
 if tmplevel = 1 then
    select deptenm,depttnm into enm1,tnm1 from department where dept_seqno=deptseqno_tmp ; 
elsif tmplevel =2 then
    select deptenm,depttnm,rel_code into enm2,tnm2,rel2 from department where dept_seqno = deptseqno_tmp;
    ...
    select deptenm,depttnm,rel_code into enm3,tnm3,rel3 from department where dept_seqno = deptseqno_tmp;
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTABBNMNEW" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTABBNMNEW" TO "BIOSAADM";
