CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTNM3LEVEL" (deptseqno_tmp Number, flag varchar2) return varchar2 is
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNM3LEVEL" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNM3LEVEL" TO "BIOSAADM";
