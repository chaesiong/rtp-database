CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTSEQNOLEVEL2" (deptseqno_tmp Number) return varchar2 is
tmp varchar2(200);
tmplevel Number(1);
relcd Number(4);
begin
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTSEQNOLEVEL2" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTSEQNOLEVEL2" TO "BIOSAADM";
