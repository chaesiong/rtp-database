CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_RPTADMIN3" (deptseqno_tmp Number, flag varchar2) return varchar2 is
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_RPTADMIN3" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_RPTADMIN3" TO "BIOSAADM";
