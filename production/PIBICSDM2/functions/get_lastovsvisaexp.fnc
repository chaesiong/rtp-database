CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_LASTOVSVISAEXP" (IMMOVS_SEQNO NUMBER) RETURN DATE IS
LASTDTE DATE;
IMMOVS_REC IMMOVERSTAY%ROWTYPE;
/******************************************************************************
...
******************************************************************************/
BEGIN
    SELECT * INTO IMMOVS_REC FROM IMMOVERSTAY WHERE IOVSEQNO = IMMOVS_SEQNO;
   ...
   EXCEPTION
     ...
     WHEN OTHERS THEN
       NULL;
END GET_LASTOVSVISAEXP;
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_LASTOVSVISAEXP" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_LASTOVSVISAEXP" TO "BIOSAADM";
