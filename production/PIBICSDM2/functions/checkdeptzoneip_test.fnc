CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."CHECKDEPTZONEIP_TEST" 
    (p_zoneseqno NUMBER,
      p_deptseqno NUMBER,
      p_ipaddress1 CHAR,
      p_ipaddress2 CHAR)
  ...
  END;
/
  GRANT EXECUTE ON "PIBICSDM2"."CHECKDEPTZONEIP_TEST" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."CHECKDEPTZONEIP_TEST" TO "BIOSAADM";
