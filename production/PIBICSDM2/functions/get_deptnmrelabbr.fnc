CREATE OR REPLACE EDITIONABLE FUNCTION "PIBICSDM2"."GET_DEPTNMRELABBR" (deptseqno_tmp Number, flag varchar2) return varchar2 is
...
elsif tmplevel = 4 then
    select deptenm,abbrnm,rel_code into enm3,tnm3,rel3 from department where dept_seqno = deptseqno_tmp;
    --select deptlevel into level2 from department where dept_seqno = rel4;    
 if level2 = 2 then
...
/
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNMRELABBR" TO "APPSUP";
  GRANT EXECUTE ON "PIBICSDM2"."GET_DEPTNMRELABBR" TO "BIOSAADM";
