...
FROM DUAL
WHERE 1 = 2
','SQL','P17_TRAVEL_HISTORY','DL_BORDERCONTROL',to_date('12.12.2019 01:05:54','DD.MM.YYYY HH24:MI:SS'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)',to_timestamp('12.12.19 01:05:54,699671000','DD.MM.RR HH24:MI:SSXFF'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)','I',null,null,':');
...
'),'SQL','P17_TRAVEL_HISTORY','DL_BORDERCONTROL',to_date('12.12.2019 01:05:54','DD.MM.YYYY HH24:MI:SS'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)',to_timestamp('12.12.19 01:05:54,767466000','DD.MM.RR HH24:MI:SSXFF'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)','I',null,null,':');
