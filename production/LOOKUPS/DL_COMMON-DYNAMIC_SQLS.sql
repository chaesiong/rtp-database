...
FROM DUAL
WHERE 1 = 2
','SQL','P17_TRAVEL_HISTORY','DL_BORDERCONTROL',to_timestamp('12-DEC-19','DD-MON-RR HH.MI.SSXFF AM'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)',to_timestamp('12-DEC-19 01.05.54.699671000 AM','DD-MON-RR HH.MI.SSXFF AM'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)','I',null,null,':');
...
'),'SQL','P17_TRAVEL_HISTORY','DL_BORDERCONTROL',to_timestamp('12-DEC-19','DD-MON-RR HH.MI.SSXFF AM'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)',to_timestamp('12-DEC-19 01.05.54.767466000 AM','DD-MON-RR HH.MI.SSXFF AM'),'admin @TOAD 13.1.0.78 - WORKGROUP\DESKTOP-CFDOCL0 (192.168.99.23)','I',null,null,':');
