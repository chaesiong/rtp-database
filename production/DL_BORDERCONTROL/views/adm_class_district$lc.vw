...
;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."ADM_CLASS_DISTRICT$LC" TO "PUNYAWII_D";
