...
;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."LOV_PAYMENT_RATE" TO "PUNYAWII_D";
