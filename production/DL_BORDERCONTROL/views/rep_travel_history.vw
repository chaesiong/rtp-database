CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" ("ROW_NUM", "GIVENNAME", "SURNAME", "FULL_NAME", "SEX", "SEX_VALUE", "DATE_OF_BIRTH", "NATIONALITY", "NATIONALITY_VALUE", "DOCUMENT_NO", "IDENTITY", "DOCUMENT_TYPE_VALUE", "DOCUMENT_CLASS", "DOCUMENT_EXPIRY_DATE", "TRANSPORT", "BRDDOCID", "IS_FINISHED", "SUPERVISOR_NAME", "VISA_TYPE", "VISA_TYPE_VALUE", "BORDERPOST", "BORDERPOST_NAME", "PORT_MOVEMENT", "PORT_MOVEMENT_VALUE", "AIRLINE", "AIRLINE_VALUE", "ORIGIN_AIRPORT", "ORIGIN_AIRPORT_VALUE", "DESTINATION_AIRPORT", "DESTINATION_AIRPORT_VALUE", "CREATED_AT", "CREATED_BY", "CREATED_BY_USERNAME", "TRAVEL_DATE") AS 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_TRAVEL_HISTORY" TO "PUNYAWII_D";
