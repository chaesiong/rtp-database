...
;
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSUPPORT";
  GRANT DELETE ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT MERGE VIEW ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."REP_RECEIPT_FINE" TO "PUNYAWII_D";
