CREATE OR REPLACE FORCE EDITIONABLE VIEW "DL_BORDERCONTROL"."V_BORDEROCUMENTS" ("BRDDOCID", "DOCTYPE", "DOCNO", "ISSUECTRY", "NAT", "DOB", "DOB_PARTIAL", "SEX", "EXPIRYDATE", "GIVENNAME", "SURNAME", "MIDDLENAME", "GIVENNAME_THAI", "SURNAME_THAI", "MIDDLENAME_THAI", "OPTIONALDATA", "AFISID", "INS_AT", "INS_BY", "DML_AT", "DML_BY", "DML_TYPE", "INS_TERMINAL", "INS_BORDERPOST", "OFFICER_OBSERVATION", "MANUAL_EXPIRY_DATE", "DOCCLASS", "PASS_VISUAL_FACE", "PASS_ICAO_FACE", "PASS_VISUALPAGE", "PASS_UVPAGE", "PASS_IRPAGE", "PASS_DG3_0", "PASS_DG3_1") AS 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."V_BORDEROCUMENTS" TO "PUNYAWII_D";
