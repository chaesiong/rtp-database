CREATE OR REPLACE EDITIONABLE TRIGGER "DL_BORDERCONTROL"."MOVEMENTS_EVOA$TIUD0" 
  for insert or update or delete on DL_BORDERCONTROL.MOVEMENTS_EVOA
compound trigger
--
  --
  /*******************************************************************************
  ...
  *******************************************************************************/
  ...
  --
  procedure L_Check_FK_Content(p_KEY_VALUE      in MOVEMENTS_EVOA.KEY_VALUE%type
                              ,o_INS_TERMINAL   in MOVEMENTS_EVOA.INS_TERMINAL%type
                              ,n_INS_TERMINAL   in MOVEMENTS_EVOA.INS_TERMINAL%type
                              ,o_INS_BORDERPOST in MOVEMENTS_EVOA.INS_BORDERPOST%type
                              ,n_INS_BORDERPOST in MOVEMENTS_EVOA.INS_BORDERPOST%type
                               --
                               ) is
    --
  ...
  --
end MOVEMENTS_EVOA$TIUD0;
/
ALTER TRIGGER "DL_BORDERCONTROL"."MOVEMENTS_EVOA$TIUD0" ENABLE;
