...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLOG" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLOG" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLOG" TO "BIOSAADM";
