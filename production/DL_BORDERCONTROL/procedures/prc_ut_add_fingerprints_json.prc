...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PRC_UT_ADD_FINGERPRINTS_JSON" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PRC_UT_ADD_FINGERPRINTS_JSON" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PRC_UT_ADD_FINGERPRINTS_JSON" TO "BIOSAADM";
