...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_IDENTITIES" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_IDENTITIES" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_IDENTITIES" TO "BIOSAADM";
