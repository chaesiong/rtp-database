...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_BLACKLIST_UTIL" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_BLACKLIST_UTIL" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_BLACKLIST_UTIL" TO "BIOSAADM";
