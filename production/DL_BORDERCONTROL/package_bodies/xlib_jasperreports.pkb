...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLIB_JASPERREPORTS" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLIB_JASPERREPORTS" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."XLIB_JASPERREPORTS" TO "BIOSAADM";
