...
/
  ...
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_DL_AUTHORIZATION" TO "BIOAPPREPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_DL_AUTHORIZATION" TO "BIOSUPPORT";
  GRANT EXECUTE ON "DL_BORDERCONTROL"."PKG_DL_AUTHORIZATION" TO "BIOSAADM";
