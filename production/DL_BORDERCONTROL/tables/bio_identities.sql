...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000312177C00019$$" ON "DL_BORDERCONTROL"."BIO_IDENTITIES" (
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."BIO_IDENTITIES" TO "PUNYAWII_D";
