...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."IDENTITIES$PK" ON "DL_BORDERCONTROL"."IDENTITIES" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOAPPREPORT";
  GRANT INSERT ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOAPPREPORT";
  GRANT UPDATE ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."IDENTITIES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."IDENTITIES" TO "PUNYAWII_D";
