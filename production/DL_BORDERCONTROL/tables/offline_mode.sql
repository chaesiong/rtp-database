...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000539714C00002$$" ON "DL_BORDERCONTROL"."OFFLINE_MODE" (
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."OFFLINE_MODE" TO "PUNYAWII_D";
