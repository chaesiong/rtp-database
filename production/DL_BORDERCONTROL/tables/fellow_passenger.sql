...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000312103C00015$$" ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" (
  ...
  GRANT ALTER ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."FELLOW_PASSENGER" TO "PUNYAWII_D";
