CREATE TABLE "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."FAF_FEES_AND_FINES" TO "PUNYAWII_D";
