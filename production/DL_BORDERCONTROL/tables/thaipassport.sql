...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."THAIPASSPORT$UQ00" ON "DL_BORDERCONTROL"."THAIPASSPORT" ("CITIZENID", "PASSPORTNO") 
  ...
  GRANT ALTER ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."THAIPASSPORT" TO "PUNYAWII_D";
