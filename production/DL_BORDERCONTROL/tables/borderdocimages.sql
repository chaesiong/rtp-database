...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."SYS_IL0000311879C00003$$" ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" (
 ...
 (PARTITION "SYS_IL_P7251" ) ;
  ...
  GRANT ALTER ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."BORDERDOCIMAGES" TO "PUNYAWII_D";
