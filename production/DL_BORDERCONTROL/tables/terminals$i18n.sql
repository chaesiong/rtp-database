...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."TERMINALS$I18N$PK" ON "DL_BORDERCONTROL"."TERMINALS$I18N" ("KEY_VALUE", "LOCALE") 
  ...
  GRANT ALTER ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "BIOSAADM";
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."TERMINALS$I18N" TO "PUNYAWII_D";
