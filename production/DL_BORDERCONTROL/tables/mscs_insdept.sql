CREATE TABLE "DL_BORDERCONTROL"."MSCS_INSDEPT" 
  ...
  GRANT ALTER ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."MSCS_INSDEPT" TO "PUNYAWII_D";
