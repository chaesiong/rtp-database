...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."CREW_MEMBERS$PK" ON "DL_BORDERCONTROL"."CREW_MEMBERS" ("KEY_VALUE") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."CREW_MEMBERS" TO "PUNYAWII_D";
