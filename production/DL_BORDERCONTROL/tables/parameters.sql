...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."PARAMETERS_UK1" ON "DL_BORDERCONTROL"."PARAMETERS" ("NAME") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."PARAMETERS" TO "PUNYAWII_D";
