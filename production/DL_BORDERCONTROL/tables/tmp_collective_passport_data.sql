CREATE TABLE "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" 
   (	"KEY_VALUE" VARCHAR2(128) DEFAULT ON NULL SYS_GUID() NOT NULL ENABLE, 
...
CREATE UNIQUE INDEX "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DA_PK" ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" ("KEY_VALUE", "APP_SESSION") 
  ...
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOAPPREPORT";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSUPPORT";
  GRANT ALTER ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT DELETE ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT INDEX ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT INSERT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT UPDATE ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT REFERENCES ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT READ ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT ON COMMIT REFRESH ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT QUERY REWRITE ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT DEBUG ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT FLASHBACK ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "BIOSAADM";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "SOMPORN_K";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "KIATTIPAT_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "WORAGON_T";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "PISAN_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "PRAMUALSOOK_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "CHAYA_W";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "CHAYAWEE_O";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "THANASET_N";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "THASAYA_M";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "PORNRUKSA_S";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "SANTIPATN_P";
  GRANT SELECT ON "DL_BORDERCONTROL"."TMP_COLLECTIVE_PASSPORT_DATA" TO "PUNYAWII_D";
