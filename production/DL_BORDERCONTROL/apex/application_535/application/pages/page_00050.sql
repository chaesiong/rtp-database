...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(343405684923553102)
,p_name=>'P50_DATE_OF_BIRTH_YEAR'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(140906072371245647)
,p_prompt=>'Year'
,p_source=>'P50_DATE_OF_BIRTH_YEAR'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT TO_CHAR(SYSDATE,''YYYY'')-LEVEL+3 as display_value, TO_CHAR(SYSDATE,''YYYY'')-LEVEL+3 as key_value FROM DUAL CONNECT BY LEVEL <= 115;'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_colspan=>5
,p_grid_label_column_span=>3
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(343405716702553103)
,p_name=>'P50_DATE_OF_BIRTH_MONTH'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(140906072371245647)
,p_prompt=>'Month'
,p_source=>'P50_DATE_OF_BIRTH_MONTH'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:01;1,02;2,03;3,04;4,05;5,06;6,07;7,08;8,09;9,10;10,11;11,12;12'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>4
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(343405852397553104)
,p_name=>'P50_DATE_OF_BIRTH_DAY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(140906072371245647)
,p_prompt=>'Day'
,p_source=>'P50_DATE_OF_BIRTH_DAY'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT LEVEL as display_value, LEVEL as key_value FROM DUAL CONNECT BY LEVEL <= 31;'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>3
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(94387450686593102)
...
'DECLARE',
' l_partial_date  travel_docs.date_of_birth_partial%type;',
' l_date_of_birth travel_docs.date_of_birth%type;',
' ',
' ',
'BEGIN',
'    SELECT ',
...
'        l_partial_date',
'    FROM travel_docs ',
'    WHERE key_value = :P50_TRAVELDOC_ID;',
'    ',
'    :P50_DATE_OF_BIRTH_YEAR  := l_partial_date.getYear();',
'    :P50_DATE_OF_BIRTH_MONTH := l_partial_date.getMonth();',
'    :P50_DATE_OF_BIRTH_DAY   := l_partial_date.getDay();',
'    ',
'    :P50_TRAVELDOC_DELETE    := APEX_LANG.MESSAGE(''TRAVELDOC.DELETE'');',
'EXCEPTION WHEN no_data_found THEN   ',
'    :P50_DATE_OF_BIRTH_YEAR  := '''';',
'    :P50_DATE_OF_BIRTH_MONTH := '''';',
'    :P50_DATE_OF_BIRTH_DAY   := ''''; ',
'',
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
