...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(134466074010750871)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(101131518327568334)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(101131661536568335)
,p_event_id=>wwv_flow_api.id(101131518327568334)
,p_event_result=>'TRUE'
