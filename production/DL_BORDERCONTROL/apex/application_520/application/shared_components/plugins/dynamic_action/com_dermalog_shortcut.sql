...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(60741631950200513)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60742532726216136)
,p_plugin_id=>wwv_flow_api.id(60741631950200513)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60759777336458182)
,p_plugin_id=>wwv_flow_api.id(60741631950200513)
,p_attribute_scope=>'COMPONENT'
