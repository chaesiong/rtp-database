...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(94798783688073293)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(94799684464088916)
,p_plugin_id=>wwv_flow_api.id(94798783688073293)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(94816929074330962)
,p_plugin_id=>wwv_flow_api.id(94798783688073293)
,p_attribute_scope=>'COMPONENT'
